 ...
 */
include '.../geral/usr/pear/PEAR.php';
...
class DB_common extends PEAR
{
    ...
    function &execute($stmt, $data = array())
    {
        ...
        if (PEAR::isError($realquery)) {
            return $realquery;
        }
        $result = $this->simpleQuery($realquery);

        if ($result === DB_OK || PEAR::isError($result)) {
            return $result;
        } else {
    ...
    function getListOf($type)
    {
        ...
        } elseif (is_int($sql) || PEAR::isError($sql)) {
            // Previous error
