 ...
 */
class Negocio_Repositorio_ComissaoLicitacao
{
     ...
     * @var string
     */
    const NOME_TABELA = 'sfpc.tbcomissaolicitacao';
     ...
     * @return mixed
     */
    public function procurar(Negocio_ValorObjeto_Ccomlicodi $ccomlicodi)
    {
        $sql = sprintf("
            SELECT *
