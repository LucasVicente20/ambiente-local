 ...
 */
class Negocio_Repositorio_DocumentoAtaRP
{
     ...
     * @var string
     */
    const NOME_TABELA = 'sfpc.tbdocumentoatarp';

    /**
     *
     * @param Negocio_ValorObjeto_Cdocatsequ $cdocatsequ            
     */
    public function procurar(Negocio_ValorObjeto_Cdocatsequ $cdocatsequ)
    {
        $sql = sprintf("
            SELECT *
