...
# -----------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadIncluirItemNovo.php
...
if($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadManterEspecial' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar'){
...
if ($ProgramaOrigem == 'CadInventarioInicialContagem' ||
    ...
    $ProgramaOrigem == 'CadManterEspecial'  ||
		...
		if( PEAR::isError($res) ){
			...
			while( $row = $res->fetchRow() ){
				...
				if($check_material != ""){ 
					...
					if($ProgramaOrigem == 'CadRequisicaoMaterialIncluir' || $ProgramaOrigem == 'CadRequisicaoMaterialAlterarIncluir'){
					...
					//O tipo do grupo (Material ou Serviço) deve ser enviado para os programas abaixo, pois estes utilizaram a inclusão de materias e serviços ativos
					} else if ($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar'){
						$material_generico = (isset($row[12]) && $row[12] == 'S') ? 'S' : 'N';
						$_SESSION['item'][count($_SESSION['item'])] = $DescricaoMaterialServicoBanco.$SimboloConcatenacaoArray.$CodRedMaterialServicoBanco.$SimboloConcatenacaoArray.$UndMedidaSigla.$SimboloConcatenacaoArray.$TipoGrupoBanco.$SimboloConcatenacaoArray.$material_generico.$SimboloConcatenacaoArray;
					} else if($ProgramaOrigem == 'CadManterEspecial'){
						$posicao = 0;
						if(!empty($_SESSION['item'])) {
							$posicao =  end(array_keys($_SESSION['item'])) + 1;
						}
						$material_generico = (isset($row[12]) && $row[12] == 'S') ? 'S' : 'N';
						$_SESSION['item'][$posicao] = $DescricaoMaterialServicoBanco.$SimboloConcatenacaoArray.$CodRedMaterialServicoBanco.$SimboloConcatenacaoArray.$UndMedidaSigla.$SimboloConcatenacaoArray.$TipoGrupoBanco.$SimboloConcatenacaoArray.$material_generico.$SimboloConcatenacaoArray;									
					} else { //Para os demais programas, é necessário enviar a situação do material/serviço
						$_SESSION['item'][count($_SESSION['item'])] = $DescricaoMaterialServicoBanco.$SimboloConcatenacaoArray.$CodRedMaterialServicoBanco.$SimboloConcatenacaoArray.$UndMedidaSigla.$SimboloConcatenacaoArray.$SituacaoMaterial.$SimboloConcatenacaoArray;
					}
				}
			}
...
if($Botao == "Validar"){
		...
		if( $SubclasseDescricaoDireta != "" and $OpcaoPesquisaSubClasse == 0 and ! SoNumeros($SubclasseDescricaoDireta) ){
			...
			$Mens = 1;
			$Tipo = 2;
			$Mensagem .= "<a href=\"javascript:document.CadIncluirItemNovo.SubclasseDescricaoDireta.focus();\" class=\"titulo2\">Código reduzido da Subclasse</a>";
			...
			$Mens = 1;
			$Tipo = 2;
			$Mensagem .= "<a href=\"javascript:document.CadIncluirItemNovo.SubclasseDescricaoDireta.focus();\" class=\"titulo2\">Descrição com no mínimo 2 caracteres</a>";
		}
		if( $MaterialDescricaoDireta != "" and $OpcaoPesquisaMaterial == 0 and ! SoNumeros($MaterialDescricaoDireta) ){
			if($Mens == 1){ $Mensagem .= ", "; }
			$Mens = 1;
			$Tipo = 2;
			$Mensagem .= "<a href=\"javascript:document.CadIncluirItemNovo.MaterialDescricaoDireta.focus();\" class=\"titulo2\">Código reduzido do Material</a>";
			...
			$Mens = 1;
			$Tipo = 2;
			$Mensagem .= "<a href=\"javascript:document.CadIncluirItemNovo.MaterialDescricaoDireta.focus();\" class=\"titulo2\">Descrição com no mínimo 2 caracteres</a>";
		}
}
?>
<html>
...
<!--
function checktodos(){
	document.CadIncluirItemNovo.Subclasse.value = '';
	document.CadIncluirItemNovo.submit();
}
function enviar(valor){
	document.CadIncluirItemNovo.Botao.value = valor;
	document.CadIncluirItemNovo.submit();
}
function validapesquisa(){
	if( ( document.CadIncluirItemNovo.MaterialDescricaoDireta.value != '' ) || ( document.CadIncluirItemNovo.SubclasseDescricaoDireta.value != '') ) {
		if(document.CadIncluirItemNovo.Grupo){
			document.CadIncluirItemNovo.Grupo.value = '';
		}
		if(document.CadIncluirItemNovo.Classe){
			document.CadIncluirItemNovo.Classe.value = '';
		}
		document.CadIncluirItemNovo.Botao.value = 'Validar';
	}
	if(document.CadIncluirItemNovo.Subclasse){
		if(document.CadIncluirItemNovo.SubclasseDescricaoFamilia.value != "") {
			document.CadIncluirItemNovo.Subclasse.value = '';
		}
	}
	document.CadIncluirItemNovo.submit();
...
<form action="CadIncluirItemNovo.php" method="post" name="CadIncluirItemNovo">
					...
					<tr>
						<td class="textonormal">
							<table border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal" bgcolor="#FFFFFF">
										...
										<table border="0" width="100%" summary="">
											<tr>
												...
												<td class="textonormal" colspan="4">
													...
													<input type="text" name="SubclasseDescricaoDireta" value="<?php echo $SubclasseDescricaoDireta; ?>" size="10" maxlength="10" class="textonormal" onFocus="javascript:document.CadIncluirItemNovo.ServicoDescricaoDireta.value = '';document.CadIncluirItemNovo.MaterialDescricaoDireta.value = '';document.CadIncluirItemNovo.TipoGrupo.value = 'M';">
											...
											<tr>
												...
												<td class="textonormal" colspan="4">
													...
													<input type="text" name="MaterialDescricaoDireta" value="<?php echo $MaterialDescricaoDireta; ?>" size="10" maxlength="10" class="textonormal" onFocus="javascript:document.CadIncluirItemNovo.ServicoDescricaoDireta.value = '';document.CadIncluirItemNovo.SubclasseDescricaoDireta.value = '';document.CadIncluirItemNovo.TipoGrupo.value = 'M';">
													<a href="javascript:validapesquisa();"><img src="../midia/lupa.gif" border="0"></a>
												</td>
											</tr>


											<?php if ($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadManterEspecial' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar'){ ?>
												<tr>
									              ...
									              <td class="textonormal" colspan="2">
								         	        ...
								         	        <input type="text" name="ServicoDescricaoDireta" value="<?php echo $ServicoDescricaoDireta; ?>" size="10" maxlength="10" class="textonormal" onFocus="javascript:document.CadIncluirItemNovo.MaterialDescricaoDireta.value = '';document.CadIncluirItemNovo.SubclasseDescricaoDireta.value = '';document.CadIncluirItemNovo.TipoGrupo.value = 'S';">
								...
								<tr>
									<td align="center" bgcolor="#DCEDF7" class="titulo3" colspan="4">PESQUISA POR FAMILIA - MATERIAL<?php echo strtoupper2($TextoServico); ?></td>
								</tr>
								<tr>
									<td colspan="4">
												...
												<td colspan="4">
													<table class="textonormal" border="0" width="100%" summary="">
													    ...
													    <?php if ($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadManterEspecial' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar'){ ?>
															<tr>
													          ...
													          <td class="textonormal">
													          	...
													          	<input type="radio" name="TipoGrupo" value="M" onClick="javascript:document.CadIncluirItemNovo.MaterialDescricaoDireta.value='';document.CadIncluirItemNovo.SubclasseDescricaoDireta.value='';document.CadIncluirItemNovo.ServicoDescricaoDireta.value='';document.CadIncluirItemNovo.submit();" <?php if( $TipoGrupo == "M" ){ echo "checked"; }?> > Material
													          	<input type="radio" name="TipoGrupo" value="S" onClick="javascript:document.CadIncluirItemNovo.MaterialDescricaoDireta.value='';document.CadIncluirItemNovo.SubclasseDescricaoDireta.value='';document.CadIncluirItemNovo.ServicoDescricaoDireta.value='';document.CadIncluirItemNovo.submit();" <?php if( $TipoGrupo == "S" ){ echo "checked"; }?> > Serviço
													          </td>
													        </tr>
												         <?php } ?>
														...
														<tr>
															...
															<td class="textonormal">
																<input type="radio" name="TipoMaterial" value="C" onClick="javascript:document.CadIncluirItemNovo.submit();" <?php if( $TipoMaterial == "C" ){ echo "checked"; } ?> /> Consumo
																<input type="radio" name="TipoMaterial" value="P" onClick="javascript:document.CadIncluirItemNovo.submit();" <?php if( $TipoMaterial == "P" ){ echo "checked"; } ?> /> Permanente
															</td>
														</tr>
														<?php } ?>
														...
														if($qtdres > 0){
																...
																while( $row = $res->fetchRow() ){
																		...
																		if($flg == "S"){ //Só ocorre para Material
																				...
																				$Url = "CadItemDetalhe.php?Material=$CodRedMaterialServicoBanco&TipoGrupo=$TipoGrupoBanco";
