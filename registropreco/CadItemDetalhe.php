											...
											<table border="0" cellpadding="0" cellspacing="0" bordercolor="#75ADE6" width="100%" summary="">
								      	    ...
								      	    <table class="textonormal" border="0" width="100%" summary="">
										        ...
										        <?php } ?>
									        	    ...
									        	    <td class="textonormal">
									        	     <?php
									        	      if ($trpCompraDireta=="0,00" ) $trpCompraDireta="...";
		      	    	...
		      	    	<?php
		      	    		if ( $ProgramaOrigem == "ConsMaterialSelecionar" && $TipoGrupo == "M" ){ //Apenas para Material
				      	    		...
				      	    		$db   = Conexao();
												...
												$sql  = "
													SELECT
														DISTINCT C.EALMPODESC, C.AALMPOFONE, G.EUSUPORESP, A.VARMATULTC
													FROM
														SFPC.TBARMAZENAMENTOMATERIAL A,
											  ...
											  if( PEAR::isError($res) ){
									                ...
									                $Preco    = "";
											              ...
											              if ( $Linha[1] != $Telefone ) {
                                                                ...
                                                                echo "	<td class=\"textonormal\" height=\"20\">$Linha[3]</td>\n";
												...
												if($_SESSION['_cgrempcodi_'] == 0 or $_SESSION['_fperficorp_'] == "S" ){ // apenas visível a administradores
													...
													$sql  = "
														SELECT DISTINCT OL.EORGLIDESC, U.AUSUPOFONE, U.EUSUPORESP
														FROM
