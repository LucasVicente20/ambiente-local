...
class CadAtaRegistroPrecoCaronaAtaExternaAlterar
{
    /**
   ...
   /**
    ...
    private function proccessVoltar()
    {
        ...
        $uri  = 'CadAtaRegistroPrecoCaronaAtaExternaListarCarona.php?ano='.$ano.'&processo='.$processo.'&orgao='.$orgao;
        header('location: ' . $uri);
    }
...
function bootstrap()
{
    ...
    $template = new TemplatePortal("templates/CadAtaRegistroPrecoCaronaAtaExternaAlterar.html");
    ...
    $app = new CadAtaRegistroPrecoCaronaAtaExternaAlterar($template, $arrayGlobals);
    echo $app->run();
