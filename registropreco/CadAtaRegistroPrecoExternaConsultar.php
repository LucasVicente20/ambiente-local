...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadAtaRegistroPrecoExternaConsultar.php
# Autor:    Carlos Abreu
# Data:     28/06/2007
...
AddMenuAcesso('/registropreco/CadAtaRegistroPrecoExternaExibir.php');
...
$ErroPrograma = "CasAtaRegistroPrecoExternaConsultar.php";
...
if ($AtaRegistroPrecoCod != "") {
    ...
    $Url = "CadAtaRegistroPrecoExternaExibir.php";
	...
	<tr>
        ...
        <tr>
          <td align="center" bgcolor="#75ADE6" valign="middle" class="titulo3">
	           CONSULTAR - ATAS DE REGISTRO DE PREÇO EXTERNA
          </td>
        </tr>
        <tr>
          <td>
                ...
                <td class="textonormal">
                    ...
                    if (PEAR::isError($result)) {
                        ...
                        while ($Linha = $result->fetchRow()) {
                            $Url = "CadAtaRegistroPrecoExternaConsultar.php?AtaRegistroPrecoCod=$Linha[0]";
                            if (!in_array($Url, $_SESSION['GetUrl'])) {
                                $_SESSION['GetUrl'][] = $Url;
                            }
