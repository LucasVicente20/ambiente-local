...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadRegistroOcorrenciaSelecionarManter.php
# Autor:    Roberta Costa
# Data:     29/09/2004
# Objetivo: Programa que Selecionar o Fornecedor para Incluir Ocorrência
# Alterado: Carlos Abreu
# Data:     15/09/2006 - Separar programas para remover chamada inicial por get (CadRegistroOcorrenciaSelecionarIncluir.php e CadRegistroOcorrenciaSelecionarManter.php)
...
<form action="CadRegistroOcorrenciaSelecionarManter.php" method="post" name="CadRegistroOcorrenciaSelecionar">
<br><br><br><br><br>
	  	      	...
	  	      	<tr>
	    	      	<td class="textonormal" colspan="4">
	      	    		<p align="justify">
	        	    		...
	        	    		clique no botão "Pesquisar". Depois, clique no fornecedor desejado para alterar ou excluir as ocorrências.<br>
