...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadRegistroOcorrenciaSelecionarIncluir.php
# Autor:    Roberta Costa
# Data:     29/09/2004
# Objetivo: Programa que Selecionar o Fornecedor para Incluir Ocorrência
# Alterado: Carlos Abreu
# Data:     15/09/2006 - Separar programas para remover chamada inicial 
#           por get (CadRegistroOcorrenciaSelecionarIncluir.php e CadRegistroOcorrenciaSelecionarManter.php)
...
<form action="CadRegistroOcorrenciaSelecionarIncluir.php" method="post" name="CadRegistroOcorrenciaSelecionar">
<br><br><br><br><br>
	  	      	...
	  	      	<tr>
	    	      	<td class="textonormal" colspan="4">
	      	    		<p align="justify">
	        	    		...
	        	    		clique no botão "Pesquisar". Depois, clique no fornecedor desejado para incluir	as ocorrências.<br>
													...
													while( $Linha	= $result->fetchRow() ){
							             				...
							             				$CPFForm = (substr($CPFForm,0,3).".".substr($CPFForm,3,3).".".substr($CPFForm,6,3)."-".substr($CPFForm,9,2));
															...
															if( ($Situacao == 2) or ($Situacao == 5) ){
																	...
																	$Url = "CadRegistroOcorrenciaIncluir.php?Sequencial=$Sequencial";
