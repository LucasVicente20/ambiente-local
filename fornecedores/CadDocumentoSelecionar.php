...
# Data:     12/11/2018
# Objetivo: Programa de Cadastro e Gestão de Documentação de Fornecedor - Selecionar
#--------------------------
...
if( $Botao == "Pesquisar" ){
		...
		if( $Argumento != "" ){
				if( ($ItemPesquisa == "CNPJ") and (!SoNumeros($Argumento)) ){
			    	$Mens 		 = 1;$Tipo = 2;
						$Mensagem .= "<a href=\"javascript:document.CadDocumento.Argumento.focus();\" class=\"titulo2\">CNPJ Válido</a>";
				}else{
						if( ($ItemPesquisa == "CPF") and (!SoNumeros($Argumento)) ){
					    	$Mens 		 = 1;$Tipo = 2;
								$Mensagem .= "<a href=\"javascript:document.CadDocumento.Argumento.focus();\" class=\"titulo2\">CPF Válido</a>";
						}
				}
		}else{
		  	$Mens 		 = 1;
		  	$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.CadDocumento.Argumento.focus();\" class=\"titulo2\">Argumento da Pesquisa</a>";
		}
}
?>
<html>
...
function enviar(valor){
	document.CadDocumento.Botao.value=valor;
	document.CadDocumento.submit();
}
<?php MenuAcesso(); ?>
//-->
</script>
...
<form action="CadDocumentoSelecionar.php" method="post" name="CadDocumento">
<br><br><br><br><br>
  ...
  <tr>
    ...
    <td align="left" class="textonormal" colspan="2">
      <font class="titulo2">|</font>
	    <a href="../index.php"><font color="#000000">Página Principal</font></a> > Fornecedores > Atualização de Documentos
	  </td>
  </tr>
  <!-- Fim do Caminho-->
	    	      	...
	    	      	<td class="textonormal" colspan="4">
	      	    		<p align="justify">
	        	    		...
	        	    		clique no botão "Pesquisar". Depois, clique no fornecedor desejado para
										proceder a atualização de documentos.<br>
	        	    		Para limpar a pesquisa, clique no botão "Limpar".<br>
	          	   	</p>
	          		</td>
	          	</tr>
		        	<tr>
															...
															if( $Sequencial != $SequencialAntes ){
									             				...
									             				$CPFForm = FormataCPF($CPF);
																	...
																	if( $Situacao == 5 ){
																			...
																			$NomePrograma = "CadGestaoDocumentos.php";
																	}
																	LimparSessao();
