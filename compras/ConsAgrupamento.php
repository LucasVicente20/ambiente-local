...
if ($_SESSION["carregarSelecionarDoSession"]) {
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        $DataIni    = filter_input(INPUT_GET, 'dataInicial');
        $DataFim    = filter_input(INPUT_GET, 'dataFinal');
        ...
        <form action="<?= $programa ?>" method="post" name="formulario">
            ...
            <table width="100%" cellpadding="3" border="0" summary="">
                ...
                <td align="left" class="textonormal" colspan="2">
                    ...
                    <a href="../index.php"><font color="#000000">Página Principal</font></a> > Compras > Agrupamento > Consultar
                </td>
                </tr>
                <!-- Fim do Caminho-->
                ...
                <td class="textonormal">
                    <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal"  bgcolor="#FFFFFF">
                        ...
                        <td align="center" bgcolor="#75ADE6" valign="middle" class="titulo3" colspan="4">
                            CONSULTAR AGRUPAMENTO - SOLICITAÇÃO DE COMPRA  E CONTRATAÇÃO (SCC)
                        </td>
                        </tr>
                        <tr>
                    ...
                    echo "selected='selected'";
                                ...
                                <?php //[CR125346]: REDMINE 73 ?>
                                <!--
                                <tr>
                                <td class="textonormal" bgcolor="#DCEDF7" width="30%" height="20">Situação*</td>
                                <td class="textonormal">-->
                                <input name="Situacao" type="hidden" value="7">
                                <!--PARA ENCAMINHAMENTO</td>
                                </tr>
                                -->
                                    ...
                                    if ( isset($RadioIdSolicitacao) & is_numeric($RadioIdSolicitacao) ){
    									...
    									<tr>
    										<td style="background-color:#F1F1F1;" colspan="4">
    											<table bordercolor="#75ADE6" border="0" cellspacing="" bgcolor="bfdaf2" width="100%" class="textonormal">
    												...
    												<?php foreach ($listaIntens as $lista) { ?>
    												<tr>
    									...
    									<?php
    										...
    										<tr>
    											...
    											<?php } else { ?>
    												<input type="button" name="ConsultarDetalhamento" value="Consultar detalhamento" class="botao" onClick="javascript:enviar('ConsultarDetalhamento')">
    											<?php } ?>
    											</td>
    										</tr>
    								<?php
