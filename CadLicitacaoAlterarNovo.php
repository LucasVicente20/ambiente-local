    ...
    if ($Mens == 0) {
        ...
        foreach ($arrOrdem as $ordem => $aitelporde) {
            ...
            if($TratamentoDiferenciado == 'E'){
                ...
                $beneficio = null;
            }else if($tratamentoDiferenciado == 'A'){
                $beneficio = 5;
            }else{
                $beneficio = 4;
            }
            ...
            $sql .= "fitelptpbe, "; // cusupocodi IS 'Código do Usuário Responsável pela Última Alteração
...
<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
    ...
    <form action="<?php $programa ?>" method="post" name="formulario">
        ...
        ?>
            <input type="hidden" name="SeqSolicitacoesAnterior[]" value="<?php
        ...
        <input type="hidden" id="limiteCompra" name="limiteCompra" value="<?php
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    ?>
                                                                ...
                                                                <input type="text" name="NCaracteres" id="NCaracteres" size="3" disabled readonly value="<?php
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="textonormal" colspan="3">
                                            <select name="TratamentoDiferenciado">
                                                <option value="N">Sem beneficios</option>
                                                <option value="E">EXCLUSIVO MEI/EPP/M</option>
                                                <option value="c">RESERVADO/SUBCONTRATAÇÃO</option>
                                        ...
                                        <td>
                                            ...
                                            <select name="LicitacaoTipoSelecionado" class="textonormal">
                                                ...
                                                foreach ($criterio as $dadosCriterio){
                                                    ...
                                                    <option value="<?php $dadosCriterio->ccrjulcodi ?>" <?php echo ($LicitacaoTipo  == $dadosCriterio->ccrjulcodi ? 'selected' : '');?>><?php $dadosCriterio->ecrjulnome ?></option>
                                                <?php }?>
                                            </select>
                        ...
                        ?>
                                    <tr>
                                        <td class="textonormal">
                                            ...
                                            ?>
                                                <input name="BloqueiosCheck[<?php $cntBloqueio ?>]" type="checkbox"
                                                    <?php
                                     ...
                                     ?>
                                        ...
                                        <tr>
                                                <td <?php echo $estiloClasstd; ?>>&nbsp;<?php echo $listaItens['citelpsequ']; ?>
                                                    <input type="hidden" name="ordem[<?php $ORDEM; ?>]" value="<?php $ORDEMITEM; ?>" /> 
                                                    <input type="hidden" name="tipoItem[<?php $ORDEM; ?>]" value="<?php $TIPO; ?>" /> 
                                                    <input type="hidden" name="codRedItem[<?php $ORDEM; ?>]" value="<?php $CODRED; ?>" />
                                                    <input type="hidden" name="lote[<?php $ORDEM; ?>]" value="<?php $LOTEITEM; ?>" />
                                                </td>
