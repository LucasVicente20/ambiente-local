									              	...
									              	<td class="textonormal"><?php echo $DescGrupo; ?></td>
										            	...
										            	<td class="textonormal" bgcolor="#DCEDF7">Material*</td>
									  	        		<td class="textonormal">
																		...
																		<textarea name="DescMaterial" cols="39" rows="5" OnKeyUp="javascript:ncaracteres(1)" OnBlur="javascript:ncaracteres(0)" OnSelect="javascript:ncaracteres(1)" class="textonormal"><?php echo $DescMaterial; ?></textarea>
																	</td>
										        		</tr>
										        		<tr>
										            	<td class="textonormal" bgcolor="#DCEDF7">Observação*</td>
									  	        		<td class="textonormal">
																		...
																		<textarea name="Observacao" cols="39" rows="5" OnKeyUp="javascript:ncaracteresO(1)" OnBlur="javascript:ncaracteresO(0)" OnSelect="javascript:ncaracteresO(1)" class="textonormal"><?php echo $Observacao; ?></textarea>
																	</td>
										        	  </tr>
									          	</table>
														</td>
