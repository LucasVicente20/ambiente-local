...
<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
	...
	<form action="CadMaterialTRPAceiteExpurgoManter.php" method="post" name="CadMaterialTRPAceiteExpurgoSelecionar">
		<br><br><br><br><br>
		<table cellpadding="3" border="0" summary="" width="100%">
			...
			<tr>
				...
				<td align="left" class="textonormal" colspan="2">
					...
					</a> > Materiais/Serviços > TRP > Aceite/Expurgo > Manter
				</td>
			</tr>
			<!-- Fim do Caminho-->
			<!-- Erro -->
			...
			<tr>
				<td width="100"></td>
				   	<td class="textonormal">
						<table  width="50%" border="1" cellspacing="0" cellpadding="0" summary="" bordercolor="#75ADE6">
							<tr>
								<td class="textonormal ">
									<table width="100%" border="0" cellpadding="3" cellspacing="1" summary="" class="textonormal">
										<tr class="">
										...
										<tr class="">
											<td class="textonormal" bgcolor="#DCEDF7" height="20" width="15%" align="left">Período da Homologação:</td>
											<td class="textonormal " bgcolor="#ffffff">
									            <?php
												$URL = "../calendario.php?Formulario=CadMaterialTRPAceiteExpurgoSelecionar&Campo=DataHomolIni";
												?>
												<input type="text" name="DataHomolIni" size="10" maxlength="10" value="<?php echo $dataHomolIni; ?>" class="textonormal">
												<a href="javascript:janela('<?php echo $URL; ?>','Calendario',220,170,1,0)">
													<img src="../midia/calendario.gif" border="0" alt="">
												</a>
												&nbsp; a
											    <?php
												$URL = "../calendario.php?Formulario=CadMaterialTRPAceiteExpurgoSelecionar&Campo=DataHomolFim";
												?>
												<input type="text" name="DataHomolFim" size="10" maxlength="10" value="<?php echo $dataHomolFim; ?>" class="textonormal">
												<a href="javascript:janela('<?php echo $URL; ?>','Calendario',220,170,1,0)">
													<img src="../midia/calendario.gif" border="0" alt="">
												</a>
											</td>
										...
										<tr class="">
											<td class="textonormal" bgcolor="#DCEDF7" height="20" width="15%" align="left">
												Tipo de Validação:
											</td>
											<td class="textonormal" width="85%" bgcolor="#ffffff">
												<select name="tipovalidacao">
                            ...
                            <tr class="bgBrancoBotoes">
								<td class="textonormal" align="right" colspan="5">
									...
									<input class="botao" name="Botao" type="hidden" value="">
                                </td>
							</tr>
						</table>
					</td>
