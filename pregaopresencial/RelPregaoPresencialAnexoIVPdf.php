...
#---------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelPregaoPresencialAnexoIVPdf.php
# Objetivo: Imprimir o Anexo IV do Pregão Presencial
# Autor:    Hélio Miranda
# Data:     14/02/2017
#---------------------------------------------------------------------------------------
# Autor:	Lucas Baracho
...
$TituloRelatorio = "Anexo IV: Lances dos Fornecedores Vencedores por Lote";
...
{	
	...
	$pdf->Cell(140,5,"Fornecedor",1,0,"C",1);
	$pdf->Cell(50,5,"Valor do Lance Arrematante",1,0,"C",1);	
	$pdf->Cell(50,5,"Valor Renegociado",1,1,"C",1);
	
	$CodLoteSelecionado = $LinhaLote[1];
	
	$sql = "SELECT		pf.npregfrazs, pf.apregfccgc, pf.apregfccpf, pl.vpregtvalv, pl.vpregtvalr
	...
	$ValorDoLanceRenegociado 	= ($LinhaVencedorLote[4] > 0 ?  number_format($LinhaVencedorLote[4], 4, ',', '.')  : "SEM RENEGOCIAÇÃO");
	
	$pdf->Cell(40,5,$CnpjCpf,1,0,"C",0);
	$pdf->Cell(140,5,$Fornecedor,1,0,"C",0);
	$pdf->Cell(50,5,$ValorDoLanceArrematante,1,0,"C",0);
	$pdf->Cell(50,5,$ValorDoLanceRenegociado,1,1,"C",0);	
