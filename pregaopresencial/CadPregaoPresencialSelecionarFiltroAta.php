...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadPregaoPresencialSelecionarFiltroAta.php
# Autor:    Hélio Miranda
# Data:     06/02/2017
...
# Alterado: Lucas Baracho
# Data:		20/06/2018
# Objetivo: Tarefa Redmine 197437
#-------------------------------------------------------------------------
...
if( $Critica == 1){
	...
	else
	{
		...
		if($UC > 0)
		{
			...
			if($intQuantidade>0){
				$Url = "CadPregaoPresencialFiltroAta.php";
			}else{
				$Url = "CadPregaoPresencialFiltroAta.php";
			}
...
<form action="CadPregaoPresencialSelecionarFiltroAta.php" method="post" name="PregaoPresencial">
<br><br><br><br><br>
<table cellpadding="3" border="0" summary="">
  ...
  <tr>
    ...
    <td align="left" class="textonormal" colspan="2">
      ...
      <a href="../index.php"><font color="#000000">Página Principal</font></a> > Pregão Presencial > Relatórios
    </td>
  </tr>
  <!-- Fim do Caminho-->
	...
	<tr>
        ...
        <tr>
          <td class="textonormal" bgcolor="#FFFFFF">
             <p align="justify">
             Para gerar a Ata de um Pregão Presencial, selecione um pregão e clique no botão "Selecionar".
             </p>
          </td>
        </tr>
        <tr>
                ...
                <td class="textonormal" bgcolor="#FFFFFF">
                  <select name="LicitacaoProcessoAnoComissaoOrgao" class="textonormal">
                  	...
                  	<?php
										...
										Busca de Pregão do Tipo Finalizado / Modificado
										...
										*/
										...
										$sql = "SELECT 		DISTINCT P.cpregasequ, P.clicpoproc, P.alicpoanop, P.cgrempcodi, P.ccomlicodi, P.corglicodi, P.fpregatipo, C.ecomlidesc, C.ccomlicodi
												FROM 		sfpc.tbpregaopresencial P, sfpc.tbcomissaolicitacao C, sfpc.tbusuariocomis U 
												WHERE 		(SELECT COUNT(M.cpregmsequ) FROM sfpc.tbpregaopresencialmembro M WHERE M.cpregasequ = P.cpregasequ AND M.epregmtipo = 'P') = 1
														AND	P.ccomlicodi = C.ccomlicodi
														AND	U.cgrempcodi = P.cgrempcodi
														AND	U.cusupocodi = ".$_SESSION['_cusupocodi_']."
														and p.ccomlicodi = u.ccomlicodi
												ORDER BY 	C.ecomlidesc ASC, P.cgrempcodi ASC, P.alicpoanop DESC, P.clicpoproc DESC";
