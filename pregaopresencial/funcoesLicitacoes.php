...
function ultimaFase($processo,$ano,$grupo,$comissao,$orgao,$db) {
	$sql .= " select  cfasescodi as ultimafase from sfpc.tbfases ";
    $sql .= " where ";
    $sql .= " afasesorde in ("; 	 
	$sql .= " select ";
	$sql .= " max(b.afasesorde) as ultimafase ";
	$sql .= " from ";
	$sql .= " sfpc.tbfaselicitacao a, sfpc.tbfases  b ";
	$sql .= " where ";
	...
	$sql .= " and a.cfasescodi = b.cfasescodi ";
	$sql .= " ) ";
