...
/**
 * Portal de Compras
 * Programa: AbaInformacoesDFD.php
...
function ExibeAbaInformacoesDFD() {
 ...
 ?>
    ...
    <form action="ConsDFD.php" method="post" id="formAbaInformacoes" name="ConsDFD">
                                                ...
                                                <table class="textonormal" id="scc_material" summary="" width="100%">
                                                    ...
                                                    <tbody>                                                               
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span><?php if($dadosDFD->dpldfdpret != NULL){echo date('d/m/Y', strtotime($dadosDFD->dpldfdpret));}?></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textonormal" id="labels">
