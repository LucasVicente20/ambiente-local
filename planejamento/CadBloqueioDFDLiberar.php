...
/**
* Portal de Compras
* Programa: CadBloqueioDFDLiberar.php
* Autor: João Madson
* Data: 03/04/2023
...
<html>
    ...
    $(document).ready(function() {
        // $.post("PostDadosBloqueioLiberar.php",{op:"anosDFD"}, function(data) {
        //     $('#selectAnoPCA').html(data);
        // })
        $.post("PostDadosBloqueioLiberar.php",{op:"getOrgao"}, function(data) {
        ...
        $("#selectAnoPCA").change(function(){
            ...
            const AreaReq = $('#selectAreaReq').val();
            console.log(anoPCA);
            console.log(AreaReq);

            // Usei length pra garantir que a variavel tem algo

            if(anoPCA.length !== 0 && AreaReq.length !== 0){
                $("#op").val("buscaLiberacao");
                $.post("PostDadosBloqueioLiberar.php", $("#CadBloqueioDFDLiberar").serialize(), function(data) {
        ...
        // o evento change do jQuery para detectar quando o selectAreaReq é alterado
        $("#selectAreaReq").change(function(){
            $("#tdload").show();
        ...
        $("#limpar").live("click", function(){
            ...
            $.post("PostDadosBloqueioLiberar.php", $("#CadBloqueioDFDLiberar").serialize(), function(data) {
                ...
                if(response.status == true){
                    $('html, body').animate({scrollTop:0}, 'slow');
                    setTimeout(function(){
                        window.location.href = "./CadBloqueioDFDLiberar.php?";
                    }, 2000);
                }
    ...
    <form action="CadBloqueioDFDLiberar.php" method="post" id="CadBloqueioDFDLiberar" name="CadBloqueioDFDLiberar">
    ...
    <table cellpadding="3" border="0" summary="">
        ...
        <tr>
            ...
            <td align="left" class="textonormal" colspan="2" style="font-size: 8pt;">
                ...
                <a href="../index.php"><font color="#000000">Página Principal</font></a> > Planejamento > DFD > Liberar Período
            </td>
        </tr>
        <!-- Fim do Caminho-->
                    ...
                    <tr>
                        <td class="textonormal" border="0" bordercolor="#75ADE6">
                            <table border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal" bgcolor="#FFFFFF">
                                <thead>
                                    <td class="titulo3" colspan="17" align="center" bgcolor="#75ADE6" valign="middle"> <b>LIBERAÇÃO DE DFD NO PERÍODO</b>
                                    </td>
                                </thead>
                                <tr>
                                    <td>
                                                ...
                                                <table class="textonormal" id="tablePesquisarDFD" summary="" width="100%">
                                                    ...
                                                    <tbody>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php
                                                                $URLIni = "../calendario.php?Formulario=CadBloqueioDFDLiberar&Campo=DataIni";
                                                                $URLFim = "../calendario.php?Formulario=CadBloqueioDFDLiberar&Campo=DataFim";
                                                            ?>
                                                            <td>
