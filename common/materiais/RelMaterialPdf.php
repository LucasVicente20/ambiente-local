...
#------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelMaterialPdf.php
# Autor:    Rossana Lira
# Data:     18/10/2006
# Objetivo: Programa de Impressão dos Relatórios de Materiais Ordenados por Material
# OBS.:     Tabulação 2 espaços
# Alterado: Luiz Alves
# Data:     15/12/2011
# Objetivo: Corrigir bug onde mostrava materiais inativos. 
# Redmine:  #4573
#------------------------------------------------------------------------------------
...
$sql  = "	SELECT MAT.CMATEPSEQU, MAT.EMATEPDESC, UND.EUNIDMSIGL 
		...
		WHERE MAT.CSUBCLSEQU = SUB.CSUBCLSEQU AND MAT.CUNIDMCODI = UND.CUNIDMCODI 
   		AND SUB.FSUBCLSITU = 'A' AND MAT.CMATEPSITU = 'A'
