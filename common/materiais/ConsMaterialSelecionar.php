...
# Data:		06/10/2020
# Objetivo: Tarefa Redmine #237237
#-----------------------------------------------------------------------------
...
if ($TipoGrupo == "M" && $Subclasse != "" and $MaterialDescricaoDireta == "" and $SubclasseDescricaoDireta == "" and $ServicoDescricaoDireta == "") {
								...
								<tr>
									<td class="textonormal" colspan="5">
										<table width="100%">
											...
											<tr>
												<td class="textonormal">
													<input type="checkbox" class="textonormal" name="Sustentaveis" value="S" <?php if( $Sustentaveis == 'S' ){ echo "checked";}?> /> Só exibir itens de material sustentáveis
												</td>
													...
													if ($qtdres > 0) {
														...
														while ($row = $res->fetchRow()) {
															...
															if ($ClasseAntes != $ClasseDescricao) {
																...
																echo "  <td class=\"titulo3\" bgcolor=\"#F7F7F7\" width=\"50%\">DESCRIÇÃO RESUMIDA DO ".strtoupper2($Descricao)."</td>\n";
