...
<div class="modal-title"><span align="center"></span></div>   
...
<form action="" method="post" name="janelaIncluirPreco">
...
<tr>
<td class="textonormal" bgcolor="#DCEDF7" width="31%">Índice de Reajuste</td>
...
<tr>
<td class="textonormal" bgcolor="#DCEDF7">Data do Reajuste</td>
<td class="textonormal" colspan="5">
<input type="text" id="data" name="data" value="" size="10" maxlength="10" class="textonormal" >
<a id="calendarioVig" style="text-decoration: none" href="javascript:janela('../calendario.php?Formulario=JanelaIncluirPreco&amp;Campo=data','Calendario',220,170,1,0)"> 
                                                <img src="../midia/calendario.gif" border="0" alt="">
                                            </a>
</td>
</tr>
</tr>
<tr><table width="100%" bordercolor="#75ADE6" border="1" cellspacing="0"><tbody><tr> <td colspan="3">
<div><input class="btn-fecha-modal botao"  name="botao_voltar" value="Incluir" onclick="enviar('Incluir')" type="button" style="float:right">
</div> </td></tr></tbody></table> </tr>
