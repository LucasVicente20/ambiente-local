...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: TabIndiceCorrecaoSelecionar.php
# Autor:    João Batista Brito
# Data:     27/10/11
# Objetivo: Programa de Manutenção do Índice Correção
#-------------------------------------------------------------------------
...
$ErroPrograma = "TabIndiceCorrecaoSelecionar.php";
...
<form action="TabIndiceCorrecaoSelecionar.php" method="post" name="Indice">
<br><br><br><br><br>
<table cellpadding="3" border="0">
  ...
  <tr>
    ...
    <td align="left" class="textonormal" colspan="2">
      ...
      <a href="../index.php"><font color="#000000">Página Principal</font></a> > Tabelas > Índice Correção > Manter
    </td>
  </tr>
  <!-- Fim do Caminho-->
	...
	<tr>
        ...
        <tr>
          <td class="textonormal">
             <p align="justify">
             Para atualizar/excluir um Índice Correção já cadastrado, selecione o Índice Correção e clique no botão "Selecionar".
             </p>
          </td>
        </tr>
        <tr>
                ...
                <td class="textonormal">
                  <select name="IndCorrCodigo" class="textonormal">
                  	...
                  	# Mostra os perfis cadastrados #
                		$db     = Conexao();
                		$sql    = "SELECT CINCORSEQU, EINCORNOME FROM SFPC.TBINDICECORRECAO ORDER BY EINCORNOME";
                		$result = $db->query($sql);
