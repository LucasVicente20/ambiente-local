...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: TabPerfilSelecionar.php
# Autor:    Rossana Lira
# Data:     04/04/03
# Objetivo: Programa de Manutenção de Perfil
...
$ErroPrograma = "TabPerfilSelecionar.php";
...
if( $Critica == 1 ){
    ...
    if( $PerfilCodigo == "" ) {
	      $Mens      = 1;
	      $Tipo      = 2;
        $Mensagem .= "<a href=\"javascript: document.Perfil.PerfilCodigo.focus();\" class=\"titulo2\">Perfil</a>";
    }else{
...
<form action="TabPerfilSelecionar.php" method="post" name="Perfil">
<br><br><br><br><br>
  ...
  <!-- Fim do Caminho-->
	...
	<tr>
        ...
        <tr>
          <td class="textonormal">
             <p align="justify">
             Para atualizar/excluir um Perfil já cadastrado, selecione o Perfil e clique no botão "Selecionar".
             </p>
          </td>
        </tr>
        <tr>
              ...
              <tr>
                ...
                <td class="textonormal">
                  <select name="PerfilCodigo" class="textonormal">
                  	<option value="">Selecione uma Perfil...</option>
                  	<?php
...
<script language="javascript" type="">
<!--
document.Perfil.PerfilCodigo.focus();
//-->
</script>
