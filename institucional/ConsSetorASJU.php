...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: ConsSetorASJU.php
# Autor:    Rossana Lira
# Data:     28/05/03
# Objetivo: Programa de Consulta do Organograma da DGCO - SETOR ASJU
...
function enviar(valor){
	document.SetorASJU.Botao.value=valor;
	document.SetorASJU.submit();
}
<?php MenuAcesso(); ?>
//-->
</script>
...
<form action="ConsSetorASJU.php" method="post" name="SetorASJU">
<br><br><br><br><br>
	        	...
	        	<table border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal">
	          	<tr>
	            	<td align="center" bgcolor="#75ADE6" valign="middle" colspan="2" class="titulo3">
		    					INFORMAÇÕES ORGANIZACIONAIS - ASSESSORIA JURÍDICA
		          	</td>
		        	</tr>
							<tr>
							  <td>
							  	<table border="0" summary="">
				      	    		...
				      	    		<p align="justify">
												...
												<p align="justify">
												  <?php
											    $Pessoa = urlencode("Sandra Fonseca Rabêlo");
											    $Para   = urlencode("sandrarabelo@recife.pe.gov.br");
												  ?>
												  E-mail: <a href="../institucional/RotEmailPadrao.php?Pessoa=<?php echo $Pessoa;?>&Para=<?php echo $Para;?>">sandrarabelo@recife.pe.gov.br</a><br>
												</p>
											</td>
										</tr>
										<tr>
				    	      	...
				    	      	<td class="textonormal"  colspan="2">
				      	    		<p align="justify">
										...
										<tr>
											...
											<td class="textonormal">
												<p align="justify">
													I - elaborar minutas de projetos de leis, decretos, portarias e demais atos normativos referentes a licitações e
													contratos administrativos, no âmbito da Administração municipal, mediante solicitação do Secretário de Finanças ou
													do Diretor da DGCO.
												</p>
												<p align="justify">
