...
if($Botao == "Incluir"){
		...
		if($Mens == 0){
              ...
              # Abre a conexão com banco de dados #
	              ...
	              if($Mens==0){
	                ...
	                if( PEAR::isError($resInsert) ){
	                  ...
	                  if( (!($Movimentacao == 2 and $EstoqueVirtual == 'S')) and PEAR::isError($resUpdate) ){
              ...
              if( PEAR::isError($resMovAnoSequSec) ){
