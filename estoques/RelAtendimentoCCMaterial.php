									...
									<table class="textonormal" border="0" align="left" summary="" width="100%">
										...
										<tr>		
												...
												<select name="TipoMaterial" class="textonormal" onchange="Botao.value='Validar';submit();">
													<option value="0"<?php if ($TipoMaterial==0){echo " selected";}?>> Específico</option>
													<option value="1"<?php if ($TipoMaterial==1){echo " selected";}?>>Todos por Atendimento</option>
													<option value="2"<?php if ($TipoMaterial==2){echo " selected";}?>>Todos por Agrupamento</option>
												</td>
										</tr>		
