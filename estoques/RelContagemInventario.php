...
#-----------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelContagemInventario.php
...
AddMenuAcesso( '/estoques/RelContagemInventarioPdf.php' );
...
if($Botao == "Limpar"){
		header("location: RelContagemInventario.php");
		exit;
		...
		if( ($Almoxarifado == "") && ($CarregaAlmoxarifado == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelContagemInventario.Almoxarifado.focus();\" class=\"titulo2\">Almoxarifado</a>";
		}
		if( ($Localizacao == "") && ($CarregaLocalizacao == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelContagemInventario.Localizacao.focus();\" class=\"titulo2\">Localização</a>";
		}
		if($Ordem == 0){
				if($Mens == 1){ $Mensagem .= ", "; }
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelContagemInventario.Ordem.focus();\" class=\"titulo2\">Ordem</a>";
		}
		if($Mens == 0){
				$Url = "RelContagemInventarioPdf.php?Almoxarifado=$Almoxarifado&Localizacao=$Localizacao&Ordem=$Ordem&".mktime();
...
function enviar(valor){
	document.RelContagemInventario.Botao.value=valor;
	document.RelContagemInventario.submit();
}
...
<form action="RelContagemInventario.php" method="post" name="RelContagemInventario">
<br><br><br><br><br>
<table cellpadding="3" border="0" summary="">
	...
	<tr>
		...
		<td align="left" class="textonormal" colspan="2">
			...
			<a href="../index.php"><font color="#000000">Página Principal</font></a> > Estoques > Relatórios > Contagem Inventário
		</td>
	</tr>
	<!-- Fim do Caminho-->
						...
						<table border="1" cellpadding="3" cellspacing="0"  bordercolor="#75ADE6" summary="" class="textonormal" width="100%">
							<tr>
								<td align="center" bgcolor="#75ADE6" valign="middle" colspan="4" class="titulo3">
									RELATÓRIO DE CONTAGEM DE INVENTÁRIO
								</td>
							</tr>
							<tr>
								<td class="textonormal">
