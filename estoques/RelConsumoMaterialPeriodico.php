								...
								<td class="textonormal" colspan="6">
									<table class="textonormal" border="0" align="left" summary="" width="100%">
										...
										<tr>
											...
											<td class="textonormal">
												<input type="radio" name=ItemZerado value=""<?php if ($ItemZerado==""){echo " checked";}?>> Não 
												<input type="radio" name=ItemZerado value="on"<?php if ($ItemZerado=="on"){echo " checked";}?>> Sim
											</td>
										</tr>
									</table>
								</td>
