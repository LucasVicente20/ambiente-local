...
#-----------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelInventarioPeriodicoConsolidar.php
...
AddMenuAcesso( '/estoques/RelInventarioPeriodicoConsolidar.php' );
AddMenuAcesso( '/estoques/RelInventarioPeriodicoConsolidarPdf.php' );
...
if($Botao == "Limpar"){
		header("location: RelInventarioPeriodicoConsolidar.php");
		exit;
		...
		if( ($Almoxarifado == "") && ($CarregaAlmoxarifado == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoConsolidar.Almoxarifado.focus();\" class=\"titulo2\">Almoxarifado</a>";
		}
		if( ($Localizacao == "") && ($CarregaLocalizacao == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoConsolidar.Localizacao.focus();\" class=\"titulo2\">Localização</a>";
		}
		if($Ordem == 0){
				if($Mens == 1){ $Mensagem .= ", "; }
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoConsolidar.Ordem.focus();\" class=\"titulo2\">Ordem</a>";
		}
		if($Mens == 0){
				$Url = "RelInventarioPeriodicoConsolidarPdf.php?Almoxarifado=$Almoxarifado&Localizacao=$Localizacao&Ordem=$Ordem&".mktime();
...
function enviar(valor){
	document.RelInventarioPeriodicoConsolidar.Botao.value=valor;
	document.RelInventarioPeriodicoConsolidar.submit();
}
...
<form action="RelInventarioPeriodicoConsolidar.php" method="post" name="RelInventarioPeriodicoConsolidar">
<br><br><br><br><br>
<table cellpadding="3" border="0" summary="">
	...
	<tr>
		...
		<td align="left" class="textonormal" colspan="2">
			...
			<a href="../index.php"><font color="#000000">Página Principal</font></a> > Estoques > Inventário > Relatórios > Consolidar Inventário
		</td>
	</tr>
	<!-- Fim do Caminho-->
						...
						<table border="1" cellpadding="3" cellspacing="0"  bordercolor="#75ADE6" summary="" class="textonormal" width="100%">
							<tr>
								<td align="center" bgcolor="#75ADE6" valign="middle" colspan="4" class="titulo3">
									RELATÓRIO DE CONSOLIDAÇÃO DE INVENTÁRIO
								</td>
							</tr>
							<tr>
								<td class="textonormal">
									<p align="justify">
										Para imprimir os dados com as diferenças na consolidação do Inventário do Almoxarifado, preencha os campos abaixo e clique no botão "Imprimir".
