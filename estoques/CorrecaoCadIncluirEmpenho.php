...
# -----------------------------------------------------------------------------
# Portal da DGCO
# Programa: CorrecaoCadIncluirEmpenho.php
# Objetivo: Baseado no programa CadIncluirEmpenho.php para verificar erro para inserir nota fiscal.
# Autor:    Rodrigo Melo
# Data:      29/07/2008
...
AddMenuAcesso( '/estoques/RotValidaEmpenhoNotaFiscal.php' );
		...
		if( $AnoEmpenho && $OrgaoEmpenho && $UnidadeEmpenho && $SequencialEmpenho && $Mens == 0){
				if( !SoNumeros($AnoEmpenho) or !SoNumeros($OrgaoEmpenho) or !SoNumeros($UnidadeEmpenho) or !SoNumeros($SequencialEmpenho) or (!SoNumeros($ParcelaEmpenho) and ($ParcelaEmpenho))) {
						...
						if(!$EmpenhoChk){
								...
								$Url = "estoques/RotValidaEmpenhoNotaFiscal.php?ProgramaOrigem=$ProgramaOrigem&Empenho=$Empenho&Botao=$Botao";
...
<form action="CorrecaoCadIncluirEmpenho.php" method="post" name="CadIncluirEmpenho">
