...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelComprovanteRecebimentoMaterialPdf.php
# Autor:    Marcus Thiago
# Data:     12/01/2006
...
# Data:     22/08/2006
# Alterado: Álvaro Faria
# Data:     01/09/2006 - Mudanças do layout do rodapé
# Alterado: Álvaro Faria
...
if($FlagItemAtendido == 1){
		...
		$Url = "RelComprovanteRecebimentoMaterial.php?Mensagem=".urlencode($Mensagem)."&Mens=1&Tipo=1";
...
function CabecalhoRodapePaisagemComprovante(){
		...
		class PDF extends FPDF {
				...
				function Header() {
						...
						$this->Cell(0,25,"Gerência Geral de Licitações e Compras",0,0,"R");
						$this->Ln(1);
