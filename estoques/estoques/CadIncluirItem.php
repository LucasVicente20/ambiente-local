 ...
 * Data:     27/08/2021
 * Objetivo: Tarefa Redmine 246174
 * ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * Alterado: Lucas Vicente 
 * Data:     26/09/2022
 * Objetivo: Tarefa Redmine 227706
 * ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
// Verifica o Tipo de Pesquisa para definir o relacionamento #  - RETIRADO OS FILTROS DE CLASSE ATIVA
$from  = "FROM SFPC.TBGRUPOMATERIALSERVICO GRU ";
$from .= "INNER JOIN SFPC.TBCLASSEMATERIALSERVICO CLA ON CLA.CGRUMSCODI = GRU.CGRUMSCODI ";

if (($TipoGrupo == "M" or $MaterialDescricaoDireta != "" or $SubclasseDescricaoDireta != "") and $ServicoDescricaoDireta == "") {
    // PARA MATERIAL
    $from .= "INNER JOIN SFPC.TBSUBCLASSEMATERIAL SUB ON SUB.CCLAMSCODI = CLA.CCLAMSCODI AND SUB.CGRUMSCODI = CLA.CGRUMSCODI ";
...
if ($ProgramaOrigem == 'CadInventarioInicialContagem' || $ProgramaOrigem == 'CadInventarioPeriodicoIncluirItem' || 
    ...
    $ProgramaOrigem == 'CadRegistroPrecoIntencaoManter' || $ProgramaOrigem == 'CadRegistroPrecoIntencaoIncluir' || 
    $ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarIncluir' || $ProgramaOrigem == 'cadMigracaoAtaAlterar' || 
    $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar' || 
    $ProgramaOrigem == 'CadContratoAntigoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarAlterar') { 
    if (($TipoGrupo == "M" or $MaterialDescricaoDireta != "" or $SubclasseDescricaoDireta != "") and $ServicoDescricaoDireta == "") {
        // PARA MATERIAL
                ...
                if ($check_material != "") {
                    if ($ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarAlterar' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir'){
                       ...
                       // $_SESSION['item'][count($_SESSION['item'])] = $DescricaoMaterialServicoBanco . $SimboloConcatenacaoArray . $CodRedMaterialServicoBanco . $SimboloConcatenacaoArray . $UndMedidaSigla . $SimboloConcatenacaoArray . $row[4] . $SimboloConcatenacaoArray . $material_generico . $SimboloConcatenacaoArray;                        
                        ...
                        if ($ProgramaOrigem == 'CadContratoAntigoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir' || $ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadRegistroPrecoIntencaoManter' || $ProgramaOrigem == 'CadRegistroPrecoIntencaoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarAlterar' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarIncluir' || $ProgramaOrigem == 'cadMigracaoAtaAlterar' || $ProgramaOrigem == 'CadAtaRegistroPrecoInternaManterEspecialAtasAlterar') {
                            if ($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadContratoAntigoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir') {   
                                if ($RepeticoesPost == '' || empty($RepeticoesPost)) {
                                    $RepeticoesPost = 1;
                                }                                        
                                ////($RepeticoesPost);die;
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" bordercolor="#75ADE6" width="100%" summary="">
                                                    <tr>
                                                        <td colspan="5">
									    			        ...
									    			        <?php
                                                            if ($ProgramaOrigem == 'CadContratoAntigoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir' || $ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadRegistroPrecoIntencaoManter' || $ProgramaOrigem == 'CadRegistroPrecoIntencaoIncluir' || $ProgramaOrigem == 'ConsHistoricoPesquisarGeral') {
                                                            ?>
									    					<tr>
                                                ...
                                                if ($qtdres > 0) {
                                                    ...
                                                    while ($row = $res->fetchRow()) {
                                                        ...
                                                        if ($ClasseAntes != $ClasseDescricao) {
                                                            ...
                                                            if ($ProgramaOrigem == 'CadSolicitacaoCompraIncluirManterExcluir' || $ProgramaOrigem == 'CadContratoAntigoIncluir' || $ProgramaOrigem == 'CadAtaRegistroPrecoExternaIncluir' ||  $ProgramaOrigem == 'CadAtaRegistroPrecoExternaSelecionarAlterar') {
