	            												...
	            												<tr>
	          	    												...
	          	    												<td class="textonormal">
	          	    								 					<select name="RPA" class="textonormal">
	          	    								 						<option value="1"<?if ($RPA==1) echo " selected";?>>RPA 1
	          	    								 						<option value="2"<?if ($RPA==2) echo " selected";?>>RPA 2
	          	    								 						<option value="3"<?if ($RPA==3) echo " selected";?>>RPA 3
	          	    								 						<option value="4"<?if ($RPA==4) echo " selected";?>>RPA 4
	          	    								 						<option value="5"<?if ($RPA==5) echo " selected";?>>RPA 5
	          	    								 						<option value="6"<?if ($RPA==6) echo " selected";?>>RPA 6
	          	    								 					</select>
