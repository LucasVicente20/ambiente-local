					...
					<table border="0" cellspacing="0" cellpadding="3" summary="">
						...
						<table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal"  bgcolor="#FFFFFF">
							...
							?>
								...
								?>
									<tr>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=$itemAno?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=$itemOrgao?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=$itemUnidade?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=$itemSequ?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=$itemData?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=converte_valor_estoques($itemValor)?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=converte_valor_estoques($itemValorAnulado)?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=converte_valor_estoques($itemValorPago)?></td>
										<td class="texto" bgcolor=<?=$cor?> align="center"><a href="javascript:AbreJanela('ConsEmpenhoDetalhe.php?Ano=<?=$itemAno?>&Orgao=<?=$itemOrgao?>&Unidade=<?=$itemUnidade?>&Sequencial=<?=$itemSequ?>',700,350);"><?=converte_valor_estoques($itemValorNF)?></a></td> <!-- Movimentação empenho -->
										<td class="texto" bgcolor=<?=$cor?> align="center"><?=converte_valor_estoques($itemDisponivelTotal)?></td>
									</tr>
									<?php
									if ($Linha[0]=="S") {
										# Parcelas do empenho
									...
									<tr>
										<table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal"  bgcolor="#FFFFFF">
											...
											?>
												<tr>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parAno?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parOrgao?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parUnidade?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parSequ?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parParcela?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=$parData?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=converte_valor_estoques($parValor)?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=converte_valor_estoques($parValorAnulado)?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=converte_valor_estoques($parValorPago)?></td>
													<td class="texto" bgcolor=<?=$corpar?> align="center"><a href="javascript:AbreJanela('ConsEmpenhoDetalhe.php?Ano=<?=$parAno?>&Orgao=<?=$parOrgao?>&Unidade=<?=$parUnidade?>&Sequencial=<?=$parSequ?>&Parcela=<?=$parParcela?>',700,350);"><?=converte_valor_estoques($itemValorParNF)?></a></td> <!-- Movimentação sub-empenho -->
													<td class="texto" bgcolor=<?=$corpar?> align="center"><?=converte_valor_estoques($parDisponivelTotal)?></td>
												</tr>
											<?
												}
												$Linhapar = $respar->fetchRow();
