									...
									<?php
		      	    				if ($ProgramaOrigem == "ConsMaterialSelecionar" && $TipoGrupo == "M") { //Apenas para Material
										...
										if (($Situacao=="I") && ($DataSubstituicao!="") && ($DataSubstituicao!=0)) {
											...
											<tr>
												<td class="textonormal" colspan='2' height="20"><a href="CadItemDetalhe.php?Material=<?php $SubstitutoCod?>&TipoGrupo=<?php $TipoGrupoBanco?>&ProgramaOrigem=CadItemDetalhe"><?php echo $SubstitutoDesc?></a></td>
												<td class="textonormal" height="20"><?php $SubstitutoCod?></td>
											</tr>
											...
											if ($res->numRows() > 0) {
												...
												while ($Linha = $res->fetchRow()) {
													...
													<tr>
														...
														<td class="textonormal" height="20"><?php $Linha[1]?></td>
														<td class="textonormal" height="20"><?php $Linha[2]?></td>
													</tr>
