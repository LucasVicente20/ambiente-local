...
#-----------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelInventarioPeriodicoDiferencas.php
...
AddMenuAcesso( '/estoques/RelInventarioPeriodicoDiferencas.php' );
AddMenuAcesso( '/estoques/RelInventarioPeriodicoDiferencasPdf.php' );
...
if($Botao == "Limpar"){
		header("location: RelInventarioPeriodicoDiferencas.php");
		exit;
		...
		if( ($Almoxarifado == "") && ($CarregaAlmoxarifado == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoDiferencas.Almoxarifado.focus();\" class=\"titulo2\">Almoxarifado</a>";
		}
		if( ($Localizacao == "") && ($CarregaLocalizacao == 'N') ){
				...
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoDiferencas.Localizacao.focus();\" class=\"titulo2\">Localização</a>";
		}
		if($Ordem == 0){
				if($Mens == 1){ $Mensagem .= ", "; }
				$Mens      = 1;
				$Tipo      = 2;
				$Mensagem .= "<a href=\"javascript:document.RelInventarioPeriodicoDiferencas.Ordem.focus();\" class=\"titulo2\">Ordem</a>";
		}
		if($Mens == 0){
				$Url = "RelInventarioPeriodicoDiferencasPdf.php?Almoxarifado=$Almoxarifado&Localizacao=$Localizacao&Ordem=$Ordem&".mktime();
...
function enviar(valor){
	document.RelInventarioPeriodicoDiferencas.Botao.value=valor;
	document.RelInventarioPeriodicoDiferencas.submit();
}
...
<form action="RelInventarioPeriodicoDiferencas.php" method="post" name="RelInventarioPeriodicoDiferencas">
<br><br><br><br><br>
<table cellpadding="3" border="0" summary="">
	...
	<tr>
		...
		<td align="left" class="textonormal" colspan="2">
			...
			<a href="../index.php"><font color="#000000">Página Principal</font></a> > Estoques > Inventário > Relatórios > Diferenças Inventário
		</td>
	</tr>
	<!-- Fim do Caminho-->
					...
					<td class="textonormal">
						<table border="1" cellpadding="3" cellspacing="0"  bordercolor="#75ADE6" summary="" class="textonormal" width="100%">
							...
							<tr>
								<td class="textonormal">
									<p align="justify">
										Para imprimir os dados com as diferenças do Inventário do Almoxarifado, preencha os campos abaixo e clique no botão "Imprimir".
