...
# ----------------------------------------------------------------------------
# Portal da DGCO
# Programa: ConsDocumentoLicitacaoDetalhes.php
# Autor:    Rodrigo Melo
# Data:     20/03/2011
# Objetivo: Programa de Detalhamento das documentações dos
...
AddMenuAcesso( '/licitacoes/RelDocumentoLicitacaoDetalhesImpressao.php' );
...
$_SESSION['PermitirAuditoria'] = 'S'; //Variável de sessão que permite fazer download de arquivos excluídos e armazenados.
...
<form action="ConsDocumentoLicitacaoPesquisar.php" method="post"
	name="Acompanhamento"><br>
<br>
<br>
<br>
	...
	<tr>
		...
		<td align="left" class="textonormal" colspan="2"><br>
			<font class="titulo2">|</font> <a href="../index.php"><font
				color="#000000">Página Principal</font></a> > Licitações > Documento > Auditoria
		</td>
	</tr>
	<!-- Fim do Caminho-->
		...
		<table border="0" cellspacing="0" cellpadding="3" bgcolor="#FFFFFF">
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="0"
					...
					<tr>
						<td align="center" bgcolor="#75ADE6" valign="middle" colspan="4"
							class="titulo3">CONSULTA DE DOCUMENTOS DE LICITAÇÃO (AUDITORIA)
						- DETALHAMENTO</td>
					</tr>
					<tr>
												...
												<?php
													...
													for($Row = 0 ; $Row < $Rows ; $Row++){
															...
															if ( file_exists($Arq) ){
																...
																if($itemExcluido=="S"){
																	$itemNome = "<a href='".$Url."' target='_blank' class='textonormal'><s style='text-decoration:line-through;'>".$itemNome."</s></a> <b>(excluído)</b>";
																}else{
...
//															}
		          	...
		          	?>
						<tr>
								...
								<form method="post" action="ConsAcompResultado.php">


								<td class="textonormal" colspan="4" align="right">
								    <?
									  //Obs: Não passada nenhum dado por GET, pois os dados já estão na sessão. Ver abaixo os dados que a tela "ConsAcompResultado.php" coloca na sessão:
									  // $_SESSION['GrupoCodigoDet'],$_SESSION['ProcessoDet'],$_SESSION['ProcessoAnoDet'],$_SESSION['ComissaoCodigoDet'],$_SESSION['OrgaoLicitanteCodigoDet']
								      $url = "RelDocumentoLicitacaoDetalhesImpressao.php";
									?>
								  <input type="button" value="Imprimir" class="botao" onclick="javascript :janela('<?echo $url?>','PortalCompras',700,300,1)">
								  <input type="submit" name="Voltar" value="Voltar" class="botao"></td>
								</form>
							</tr>
						</table>
						</td>
