...
$codModalidade = $buscar['modalidade'];


$dados = relatorioGerencialTramitacao($buscar, 'relGerencial');
$arrBase = getComissoesRelGerencialTramitacao($buscar, '');
...
<td colspan="4" class="titulo3" bgcolor="#D3D3D3" class="textonormal" align="center">MODALIDADE : '.$dados[0][23].'</td>
</tr>';
if(!empty($arrBase)) { 
			...
			foreach($arrBase as $value) {
				...
				$htmlCabecalhoItem .= '
				<tr>
					<td rowspan="2" class="titulo3" bgcolor="#D3D3D3" class="textonormal" align="center">COMISSÃO</td>
