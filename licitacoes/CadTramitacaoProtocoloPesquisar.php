...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: CadTramitacaoProtocoloPesquisar.php
#-------------------------------------------------------------------------
...
$ErroPrograma = "CadTramitacaoProtocoloPesquisar.php";
...
if($botao == 'SelecionarGrupo') {
    ...
    header('Location: CadTramitacaoProtocoloPesquisar.php');
}
...
<form action="CadTramitacaoProtocoloPesquisar.php" method="POST" name="CadTramitacaoProtocoloPesquisar">
    <br><br><br><br><br>
    <table cellpadding="3" border="0" summary="">
        ...
        <tr>
            ...
            <td align="left" class="textonormal" colspan="2">
                ...
                <a href="../index.php"><font color="#000000">Página Principal</font></a> > Licitações > Tramitação > Número Protocolo > Manter
            </td>
        </tr>
        <!-- Fim do Caminho-->
                        ...
                        <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal"  bgcolor="#FFFFFF">
                            ...
                            <tr>
                                <td align="center" class="textonormal">
                                    ...
                                    ?>
                                    <a href="CadTramitacaoProtocoloManter.php?protocolo=<?php echo $value[0].$url; ?>">
