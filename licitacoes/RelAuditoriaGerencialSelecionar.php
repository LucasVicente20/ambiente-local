...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelAuditoriaGerencialSelecionar.php
# Autor:    Roberta Costa
# Data:     03/01/05
# Objetivo: Programa de Relatório da Auditoria Gerencial
...
AddMenuAcesso( '/licitacoes/RelAuditoriaGerencialPdf.php' );
...
if( $Botao == "Gerar" ){
		...
		if( $Mens == 0 ) {
				$Url = "RelAuditoriaGerencialPdf.php?OrgaoLicitante=$OrgaoLicitante&Comissao=$Comissao&Exercicio=$Exercicio&".mktime();
...
<form action="RelAuditoriaGerencialSelecionar.php" method="post" name="Auditoria">
<br><br><br><br><br>
<table cellpadding="3" border="0" summary="">
	...
	<tr>
		...
		<td align="left" class="textonormal" colspan="2">
			...
			<a href="../index.php"><font color="#000000">Página Principal</font></a> > Licitações > Relatórios > Auditoria > Geral
		</td>
	</tr>
	<!-- Fim do Caminho-->
						...
						<table border="1" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" class="textonormal" summary="">
							<tr>
								<td align="center" bgcolor="#75ADE6" valign="middle" class="titulo3">
									AUDITORIA GERAL - SELECIONAR
								</td>
							</tr>
							<tr>
								<td class="textonormal">
									<p align="justify">
										Para gerar o relatório de Auditoria Geral preencha os campos abaixo e clique no botão "Gerar".
