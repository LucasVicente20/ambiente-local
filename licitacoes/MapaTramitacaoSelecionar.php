...
#-------------------------------------------------------------------------
# Portal da DGCO
# Programa: MapaTramitacaoSelecionar.php
#-------------------------------------------------------------------------
...
$ErroPrograma = "MapaTramitacaoSelecionar.php";
...
<script language="javascript" type="">
    ...
    function enviar(valor){
        ...
        document.MapaTramitacaoSelecionar.Botao.value=valor;
        document.MapaTramitacaoSelecionar.submit();
    }
    ...
    $(document).ready(function() {
        $(".capturarValorAcaoGrupo").change(function() {
            ...
            document.MapaTramitacaoSelecionar.Botao.value = acao;
            document.MapaTramitacaoSelecionar.submit();
        });
    });
</script>
<script language="JavaScript">Init();</script>
<form action="MapaTramitacaoSelecionar.php" method="POST" name="MapaTramitacaoSelecionar">
    <br><br><br><br><br>
                            ...
                            <table border="0" summary="" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="textonormal">
                                        ...
                                        <a style="text-decoration: none;" href="javascript:janela('../calendario.php?Formulario=MapaTramitacaoSelecionar&Campo=tramitacaoDataEntradaInicio','Calendario',220,170,1,0)">
                                        ...
                                        <a href="javascript:janela('../calendario.php?Formulario=MapaTramitacaoSelecionar&Campo=tramitacaoDataEntradaFim','Calendario',220,170,1,0)">
                                            <img src="../midia/calendario.gif" border="0" alt="">
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <?php foreach ($dados as $key => $value) {?>
                                    <tr>
                                        <td align="center" class="textonormal">
                                            <?php
                                                $url = '&numprotocolo='.$value[1];
                                                $url .= '&anoprotocolo='.$value[5];
                                            ?>
                                            <a href="mapaTramitacao.php?protsequ=<?php echo $value[0].$url; ?>">
