...
#----------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelAuditoriaGerencialPdf.php
# Autor:    Roberta Costa
# Data:     03/01/05
# Objetivo: Programa que Gerar o Relatório de Auditoria Gerencial - PDF
...
AddMenuAcesso( '/licitacoes/RelAuditoriaGerencialSelecionar.php' );
...
$ErroPrograma = "RelAuditoriaGerencialPdf.php";

# Fução exibe o Cabeçalho e o Rodapé #
CabecalhoRodapePaisagem();

# Informa o Título do Relatório #
$TituloRelatorio = "Relatório de Auditoria Geral dos Processos Homologados com Valor Estimado Diferente do Valor Homologado";
...
$sql   .= " WHERE A.VLICPOVALE <> 0.00 AND A.VLICPOVALE IS NOT NULL ";
$sql   .= "   AND A.VLICPOVALH <> 0.00 AND A.VLICPOVALH IS NOT NULL ";
$sql   .= "   AND A.VLICPOVALE <> A.VLICPOVALH  AND A.ALICPOANOP = $Exercicio ";
...
if( PEAR::isError($result) ){
    ExibeErroBD("$ErroPrograma\nLinha: ".__LINE__."\nSql: $sql");
		...
		if( $Rows == 0 ){
				...
				$Url = "RelAuditoriaGerencialSelecionar.php?Mensagem=$Mensagem&Mens=1&Tipo=1";
