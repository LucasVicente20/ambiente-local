																	...
																	<tr>
				                                                        <td class="textonormal" bgcolor="#DCEDF7" height="20">Observação</td>
				                                                            <td class="textonormal">
																			     ...
																			     <input type="text" name="NCaracteresOBS" disabled size="3" value="<?phpecho $NCaracteresOBS ?>"  class="textonormal"><br>
																			     <textarea name="Obs" cols="50" rows="5" OnKeyUp="javascript:ncaracteresobs(1)" OnBlur="javascript:ncaracteresobs(0)" OnSelect="javascript:ncaracteresobs(1)" class="textonormal"><?phpecho $Obs; ?></textarea>
																	         </td>
