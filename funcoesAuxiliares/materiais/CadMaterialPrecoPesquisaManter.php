																...
																<tr>
																	...
																	<tr>
																		...
																		<td>
																			...
																			<input type="text" class="textonormal" name="RazaoSocial" value="<?php echo $RazaoSocial;?>" size="40" maxlength="40"  <?phpif (!empty($CodFornecedor)) echo "readonly";   ?>  >
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td>
																			<input type="text" class="textonormal" name="DDD" value="<?php echo $DDD;?>" size="5" maxlength="5"  <?phpif (!empty($CodFornecedor)) echo "readonly";   ?> >
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td>
																			<input type="text" class="textonormal" name="Telefone" value="<?php echo $Telefone;?>" size="33" maxlength="30"  <?phpif (!empty($CodFornecedor)) echo "readonly";   ?> >
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td>
																			...
																			<textarea name="Observacao2" cols="39" rows="5" OnKeyUp="javascript:ncaracteres(1)" OnBlur="javascript:ncaracteres(0)" OnSelect="javascript:ncaracteres(1)" class="textonormal"><?phpecho $Observacao2; ?></textarea>
