...
<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
 ...
 function enviar (){
	...
	<form action="CadMaterialTRPAceiteExpurgoManter.php" method="get"
	...
	<!-- Fim do Erro -->
											...
											<table width="100%" border="1" cellpadding="3"
												...
												<tr>
													<td align="center" bgcolor="#75ADE6" valign="middle"
														class="titulo3" colspan="5">MANTER ACEITE/EXPURGO PREÇOS
														TRP</td>
												</tr>
												<tr>
											<?
        ...
        // $sql1 .= " AND TRP.CTRPREULAT >= '$dataMinimaValidaTrp'";
