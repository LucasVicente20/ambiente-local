 ...
 * Data:     23/07/2021
 * Objetivo: Ajustar os Campos de Relatorio
 * ---------------------------------------------------------------------------
...
class Pitang_App_ConsTodasLicitacoesDetalhe
{
    ...
    {
        if ($_SERVER ['HTTP_REFERER'] != HelperPitang::getUrlBase() . 'ConsTodasLicitacoesCovidResultado.php') {
...
$tpl = new TemplateAppPadrao('templates/ConsTodasLicitacoesCovidDetalhes.html', 'ConsTodasLicitacoesCovidResultado');
