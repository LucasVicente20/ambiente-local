...
function PesquisarSCC($dados){
    ...
    if($dados){
        ...
        $sql .= " WHERE scc.csitsocodi IN (3,4,11) AND scc.ctpcomcodi IN (3,4) ";
...
{
    $tpl = new TemplateAppPadrao(CAMINHO_SISTEMA.'app/templates/ConsTodasDispensaInexigibilidade.html', 'ConsAvisoDispensaInexigibilidade');
