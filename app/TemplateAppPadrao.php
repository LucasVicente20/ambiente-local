 ...
 * Alterado: Osmar Celestino
 * Data:     13/06/2021
 * Objetivo: Tarefa Redmine  #249906
 * -----------------------------------------------------------------------------]* Alterado: Osmar Celestino
 * Data:     02/06/2021
 * Objetivo: Tarefa Redmine  #263044
 * -----------------------------------------------------------------------------
 */
...
class TemplateAppPadrao extends TemplateApp
{
   ...
   private $LINKACESSIBILIDADE = "";
    ...
    {
        parent::__construct('templates/layout-default.html');
        $this->buildMenuPrincipal();
        $this->FORM = $form;
        $this->LINKACESSIBILIDADE = "http://transparencia.recife.pe.gov.br/codigos/css/acessibilidade.css";
        $this->BLOCK('BLOCK_FORM');
        $this->addFile('CORPO', $file);
        $this->BASE_URL = HelperPitang::getUrlBase();
