...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadContratoPesquisar.php
...
<script language="javascript" type="">
	...
	function montaTabelaView( objJson,orgao){
		...
		for(k in orgao){
			if(orgao[k].eorglidesc != '' && orgao[k].eorglidesc != 'undefined'){
				...
				tableHtml  	 +='<div id="formTablePesquisa" style=" position:relative; " width = "100%" >';
    ...
    $(document).ready(function() {
		...
		$.post("postDadosPesquisaManterContrato.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosPesquisaManterContrato.php",
					{
						op					:"PesquisaContrato",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosPesquisaManterContrato.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
							...
							<td colspan="8">
								<table border="0" width="100%" summary="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="textonormal" width="50%">
                                            <input type="radio" class = "radioContratos" style= "margin-top: 5px;"  name="cpf-cnpj" id="radio-cpf" value="CPF"><label for="cpf">CPF</label>
