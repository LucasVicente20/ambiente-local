...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadMedicaoPesquisar.php
...
unset($_SESSION['idContratoMedMant']);
?>
<html>
<?php
...
<script language="javascript" type="">
	...
	function selecionar(registro){
		...
		if(registro != '' && registro!= null && registro !='undefined' ){
			...
			$("#formPesquisa").attr('action','./CadMedicaoManter.php');
			$("#formPesquisa").submit();
		}
	}
	<!--
    $(document).ready(function() {
		...
		$.post("postDadosPesquisaMedicaoManter.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosPesquisaMedicaoManter.php",  //Post criado para pesquisa de manter medição
					{
						op					:"PesquisaContrato",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosPesquisaMedicaoManter.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
