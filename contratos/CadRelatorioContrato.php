...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadRelatorioContrato.php
...
//		console.log(registro);
		if(registro != '' && registro!= null && registro !='undefined' ){
			...
			$("#formPesquisa").attr('action','./CadRelatorioContratoPdf.php');
			$("#formPesquisa").submit();
		}
	}
    ...
    $(document).ready(function() {
        ...
        $("#btnPesquisar").on('click', function(){
			...
			if(periodo == ""){
				$('html, body').animate({scrollTop:0}, 'slow');
				$(".mensagem-texto").html("Informe: Quantidade de dias no campo 'A Vencer/Vencido'.");
				$(".error").html("Atenção!");
				$("#tdmensagem").show();
				return false;
			}else{
		...
		<table cellpadding="3" border="0" summary="">
			...
			<tr>
				...
				<td align="left" class="textonormal" colspan="2">
					...
					</a> > Contrato > Relatório Contratos a Vencer / Vencidos
				</td>
			</tr>
			<!-- Fim do Caminho-->
			<!-- Erro -->
							...
							<td colspan="8">
								<table border="0" width="100%" summary="">
									...
									<td class="textonormal" bgcolor="#DCEDF7" width="50%">
                                        ...
                                        <td class="textonormal" width="50%">
                                            <input type="radio" name="vencido-vencer" id="vencer" value="vencer"><label for="vencer">A vencer</label>
                                            <input type="radio" name="vencido-vencer" id="vencido" value="vencido" checked><label for="vencido">Vencido</label>
                                        </td>
									</tr>
                                    <tr>
									<td class="textonormal" bgcolor="#DCEDF7" width="50%">
                                        ...
                                        <td class="textonormal" width="50%">
											<!-- <div class="textonormal"  id="periodorel" > -->
												<input type="text" name="periodo" id="periodo" size=5><spam> Dias<spam>
											<!-- </div> -->
                                        </td>
									</tr>
									<tr>
