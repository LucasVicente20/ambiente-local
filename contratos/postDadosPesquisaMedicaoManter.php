...
# Portal da Compras
# Programa: CadMedicaoPesquisar.php
# Autor:    Osmar Celestino | Marcello Calvalcanti
# Data:     26/05/2021
# CR:       248617
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------
...
require_once "ClassManterMedicaoPesquisar.php"; //Alteração da classe para uma classe exclusiva de mantermedição pesquisar

$ObjContrato = new ContratoPesquisar();
$ObjMedicao = new ManterMedicaoPesquisar();
$arrayTirar  = array('.',',','-','/');
...
switch($_POST['op']){
    ...
    case "PesquisaContrato":
        ...
        $dadosTabela = $ObjMedicao->Pesquisar($ArrayDados);
        ...
        foreach($dadosOrgao as $infOrgao){
                foreach($dadosTabela as $informacoesTable){
                    if($informacoesTable->eorglidesc == $infOrgao->eorglidesc){
                        ...
                        $situacaoForne = $ObjContrato->GetSituacaoFornecedor($informacoesTable->aforcrsequ);
                        $TipoCompra    = $ObjContrato->GetTipoCompra($informacoesTable->ctpcomcodi);
                        $SituacaoContrato  = $ObjMedicao->GetSituacaoContrato($informacoesTable->cfasedsequ);
