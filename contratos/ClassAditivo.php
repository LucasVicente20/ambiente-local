...
#---------------------------------------------------------------------------
    ...
    class ClassAditivo
    {
        ...
        public function insereDadosAditivo($dadosSalvar){
            ...
            $justificativa = removeSimbolos(RetiraAcentos($dadosSalvar['XADITIJUST']));
            $observacao = removeSimbolos(RetiraAcentos($dadosSalvar['XADITIOBSE']));
            if(empty($dadosSalvar['AFORCRSEQU'])){
                    $dadosSalvar['AFORCRSEQU'] = "'" . $dadosSalvar['AFORCRSEQU'] ."'";
                    $sql = "INSERT INTO SFPC.TBADITIVO(
                        ...
                        NADITIPRRL, NADITIMLRL, EADITITLRL, CUSUPOCODI, TADITIULAT, DADITIFIEX) ";
                    $sql .= "VALUES ("; 
                    $sql .= $num_max_documento.", ".$dadosSalvar['CDOCPCSEQ1'].", ".$dadosSalvar['CTPADISEQU'].", ".$numMaxAditivo.", '".$justificativa."', now(), '".$dadosSalvar['FADITIALPZ']."', ";
                    $sql .= $dadosSalvar['AADITIAPEA'].", '".$dadosSalvar['FADITIALVL']."', '".$dadosSalvar['FADITIALCT']."', '".$dadosSalvar['CADITITALV']."', '".$this->floatvalue($dadosSalvar['VADITIREQC'])."', '".$this->floatvalue($dadosSalvar['VADITIVTAD'])."', ".$dadosSalvar['DADITIINVG'].", ".$dadosSalvar['DADITIFIVG'].", ". $dadosSalvar['DADITIINEX'].", '". $observacao."', '";
                    ...
                    $sql .= $dadosSalvar['NADITINARL']."', '".$dadosSalvar['CADITIECRL']."', '".$dadosSalvar['NADITIPRRL']."', '".$dadosSalvar['NADITIMLRL']."', '".$dadosSalvar['EADITITLRL']."', ".$cusupocodi .", now(), ".$dadosSalvar['DADITIFIEX'].")";
        ...
        public function atualizaDadosAditivo($dadosSalvar, $validaFornecedor){
            $cusupocodi = $_SESSION['_cusupocodi_'];
            ...
            $justificativa = removeSimbolos(RetiraAcentos($dadosSalvar['XADITIJUST']));
            $observacao = removeSimbolos(RetiraAcentos($dadosSalvar['XADITIOBSE']));
            if(!empty($dadosSalvar['EADITICGCC'])||!empty($dadosSalvar['EADITICPFC'])){ 

                $sql  = "UPDATE SFPC.TBADITIVO SET".
                        "   CTPADISEQU = ". $dadosSalvar['CTPADISEQU']. ", AADITIAPEA = ". $dadosSalvar['AADITIAPEA'].
                        ",  AADITINUAD = '". $dadosSalvar['AADITINUAD']."', XADITIJUST = '". $justificativa. 
                        ...
                        ", DADITIINEX = ". $dadosSalvar['DADITIINEX'].", XADITIOBSE = '". $observacao.
                        ...
                        "', EADITICPFC = '". $dadosSalvar['EADITICPFC']."', EADITICGCC = '". $dadosSalvar['EADITICGCC']."', AFORCRSEQU= ". $dadosSalvar['AFORCRSEQU'] .", DADITIFIEX = ".$dadosSalvar['DADITIFIEX'];
            
                $sql .= " WHERE CDOCPCSEQU = ". $dadosSalvar['CDOCPCSEQU']." AND CDOCPCSEQ1 = ". $dadosSalvar['CDOCPCSEQ1'];
            }elseif($dadosSalvar['CTPADISEQU'] != 13){   
                    $sql  = "UPDATE SFPC.TBADITIVO SET".
                    "   CTPADISEQU = ". $dadosSalvar['CTPADISEQU']. ", AADITIAPEA = ". $dadosSalvar['AADITIAPEA'].
                    ",  AADITINUAD = '". $dadosSalvar['AADITINUAD']."', XADITIJUST = '". $justificativa. 
                    "', FADITIALPZ = '". $dadosSalvar['FADITIALPZ']."', FADITIALVL = '". $dadosSalvar['FADITIALVL'].
            ...
            $sql .= " WHERE CDOCPCSEQU = ". $dadosSalvar['CDOCPCSEQU']." AND CDOCPCSEQ1 = ". $dadosSalvar['CDOCPCSEQ1'];
                    ...
                    if(empty($dadosSalvar['EADITICGCC']) && empty($dadosSalvar['EADITICPFC'])){
                        $sql  = "UPDATE SFPC.TBADITIVO SET".
                            ...
                            "', NADITINARL = '". $dadosSalvar['NADITINARL']."', CADITIECRL = '". $dadosSalvar['CADITIECRL'].
                            "', NADITIPRRL = '". $dadosSalvar['NADITIPRRL']."', NADITIMLRL = '". $dadosSalvar['NADITIMLRL'].
                            "', EADITITLRL = '". $dadosSalvar['EADITITLRL']."', CUSUPOCODI= ". $cusupocodi .", TADITIULAT = now(), DADITIFIEX = ".$dadosSalvar['DADITIFIEX'];
            ...
            if($dadosSalvar['CTPADISEQU'] == 13 && $validaFornecedor == True){
        ...
        public function getAditivosContrato($codCont){
            ...
            $sql = "SELECT DOC.CFASEDSEQU as fase, CASE WHEN cctrpcopex = 'M' AND FADITIALPZ = 'SIM' AND DADITIFIEX IS NULL ";
            $sql .= "THEN to_char(cast(daditiinex AS DATE) + ((aaditiapea)::text || ' ' || 'MONTHS')::interval, 'DD/MM/YYYY') ";
            $sql .= "WHEN cctrpcopex = 'M' AND FADITIALPZ = 'SIM' AND DADITIFIEX IS NOT NULL THEN to_char(DADITIFIEX, 'DD/MM/YYYY') ";
            $sql .= "WHEN cctrpcopex = 'D' AND FADITIALPZ = 'SIM' AND DADITIFIEX IS NULL ";
            $sql .= "THEN to_char(daditiinex + ((aaditiapea)::text || ' ' || 'DAYS')::interval, 'DD/MM/YYYY') ";
            $sql .= "WHEN cctrpcopex = 'D' AND FADITIALPZ = 'SIM' THEN to_char(DADITIFIEX, 'DD/MM/YYYY') END AS data_fim_execucao_calculada, ";
            // $sql .= "WHEN cctrpcopex = 'D' AND FADITIALPZ = 'SIM' THEN to_char(DADITIFIEX, 'DD/MM/YYYY') END AS data_fim, ";  data fim estava vindo para vigencia por erro de lógica troquei o nome para evitar erro.
            $sql .= "ADIT.CDOCPCSEQU, ADIT.CDOCPCSEQ1, ECTRPCNUMF, ADIT.XADITIJUST, ADIT.AADITINUAD, SIT.ESITDCDESC,ADIT.DADITIINVG, ";
            $sql .= "ADIT.DADITIFIVG, ADIT.DADITIINEX, ADIT.VADITIVALR, ADIT.AADITIAPEA, ADIT.vaditireqc, ADIT.vaditivtad, ADIT.DADITIFIEX ";
            $sql .= "FROM SFPC.TBCONTRATOSFPC CONT, SFPC.TBADITIVO ADIT, SFPC.TBDOCUMENTOSFPC DOC, SFPC.TBSITUACAODOCUMENTO SIT ";
            $sql .= "WHERE CONT.CDOCPCSEQU = ADIT.CDOCPCSEQ1 ";
            $sql .= "AND ADIT.CDOCPCSEQU = DOC.CDOCPCSEQU ";
            $sql .= "AND DOC.CFASEDSEQU = SIT.CFASEDSEQU ";
        ...
        public function insereDadosApostilamento($dadosSalvar)
        {
           ...
           if(!empty($dadosSalvar['EAPOSTNAGT'])){
            ...
            $sql = "INSERT INTO SFPC.TBAPOSTILAMENTO(
                    ...
                    NAPOSTMTGT, NAPOSTMLGT, EAPOSTTLGT, VAPOSTVTAP, CUSUPOCODI, TAPOSTULAT, VAPOSTRETR) ";
            $sql .= "VALUES ("; 
    ...
    // ===========================================================================================================================================================//
        ...
        */
        ...
        public function validarDadosAditivo($dados){
            ...
            $qtdobs = strlen(removeSimbolos(RetiraAcentos($dados['XADITIOBSE'])));
            $qtdjust = strlen(removeSimbolos(RetiraAcentos($dados['XADITIJUST'])));

            if($qtdobs > 1000){
                $resp = array("status" => false,"msm" => "Quantidade de Caracteres da Observação deve ser menor que 1000.");
                print(json_encode($resp));
               die;
            }

            if($qtdjust > 500){
                $resp = array("status" => false,"msm" => "Quantidade de Caracteres da Justificativa deve ser menor que 500.");
                print(json_encode($resp));
               die;
            }
            ...
            if(empty($dados['CTPADISEQU']) || $dados['CTPADISEQU'] == NULL || $dados['CTPADISEQU'] == "Selecione o tipo de Aditivo"){
            ...
            if($dados['FADITIALVL'] == "SIM"){
                ...
                */
                ...
                if(empty($dados['CADITITALV']) || $dados['CADITITALV'] == NULL || $dados['CADITITALV'] == "Selecione o tipo de Alteração..."){
        ...
        function validarDados($dados){
            ...
            if(intval($dados['tipo_apostilamento']) == 1 || intval($dados['tipo_apostilamento'] == 4)){
                ...
                if(empty($dados['data']) || $dados['data'] == NULL){
                    $resp = array("status" => false,"msm" => "Informe: Data do apostilamento.");
                    print(json_encode($resp));
                    return false;
                }
            }
        ...
        public function updatefornecedorPorAditivo($dadosSalvar){
            ...
            $sqlForn = "SELECT forn.aforcrsequ as seqfornecedor, forn.nforcrrazs as razao, forn.eforcrlogr as rua, forn.aforcrnume as numero, forn.eforcrcomp as complemento, 
                        ...
                        inner join SFPC.TBFORNECEDORCREDENCIADO as forn on  (forn.aforcrsequ = ad.aforcrsequ)
            ...
            //var_dump(is_null($dadosFornAdit));
            ...
            if(is_null($dadosFornAdit)){
                ...
                $updateFC .= " ectrpcraza = '".$dadosFornOriginal->razao."',";
                if(!empty($dadosFornOriginal->cep)){ $updateFC .= " cctrpcccep = $dadosFornOriginal->cep,"; }
                if(!empty($dadosFornOriginal->rua)){  $updateFC .= " ectrpclogr = '".$dadosFornOriginal->rua."',";  }
                if(!empty($dadosFornOriginal->numero)){$updateFC .= " actrpcnuen = $dadosFornOriginal->numero, "; }
                if(!empty($dadosFornOriginal->complemento)){ $updateFC .= "ectrpccomp = '".$dadosFornOriginal->complemento."',"; }
                if(!empty($dadosFornOriginal->bairro)){ $updateFC .= " ectrpcbair = '".$dadosFornOriginal->bairro."',"; }
                if(!empty($dadosFornOriginal->cidade)){ $updateFC .= " nctrpccida = '".$dadosFornOriginal->cidade."',"; }
                if(!empty($dadosFornOriginal->estado)){ $updateFC .= " cctrpcesta = '".$dadosFornOriginal->estado."',"; }
                if(!empty($dadosFornOriginal->telefone)){$updateFC .= "ectrpctlct = '".$dadosFornOriginal->telefone."'"; }
                $updateFC .= "where cdocpcsequ = $cdocpcseq1";
                //print_r($updateFC);
                ...
                $numen = !empty($dadosFornAdit->numero)? $dadosFornAdit->numero : "null";
                $numCep = !empty($dadosFornAdit->cep)? $dadosFornAdit->cep : "null";
                $updateFC = "update sfpc.tbcontratosfpc set aforcrsequ = $dadosFornAdit->seqfornecedor,
                ectrpcraza = '".$dadosFornAdit->razao."', cctrpcccep = $numCep, ectrpclogr = '".$dadosFornAdit->rua."', 
                actrpcnuen = $numen, ectrpccomp = '".$dadosFornAdit->complemento."', ectrpcbair = '".$dadosFornAdit->bairro."', 
