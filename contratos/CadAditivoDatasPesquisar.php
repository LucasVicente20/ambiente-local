...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadAditivoDataPesquisar.php
...
//		console.log(registro);
		if(registro != '' && registro!= null && registro !='undefined' ){
			...
			$("#formPesquisa").attr('action','./CadAditivoDatasManter.php');
			$("#formPesquisa").submit();
		}
	}
    ...
    $(document).ready(function() {
		...
		$.post("postDadosAditivoDatas.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnIncluir").on('click', function(){
            window.location.href="./CadAditivoDatasManter.php";
        });
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosAditivoDatas.php",
					{
						op					:"Pesquisa",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosAditivoDatas.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
...
<body background="../midia/bg.gif" marginwidth="0" marbtnginheight="0">
