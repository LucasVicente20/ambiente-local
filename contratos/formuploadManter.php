...
<body>
    <div>
        <form action="" enctype="multipart/form-data" method="post" id="formDocumento" name="formDocumento">
            ...
            <input type="hidden" name="idRegistro" id="idRegistro" value="<?php echo !empty($_GET['idRegistro'])?$_GET['idRegistro']:'';?>">
...
<script>
    ...
    function MostraDoc(){
        ...
        data.append('idRegistro', document.querySelector("#idRegistro").value);
        ...
        xhr2.open("POST",'postDadosManter.php', true);
        xhr2.send(data);
    ...
    function subirArquivo(){
        ...
        xhr.open("POST",'postDadosManter.php', true);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState < 4)  {           
                ...
                // document.querySelector("#msgDoc").innerHTML ='A carregando...';
