...
#-----------------------------------------------------------------------------------------
# Portal da DGCO
# Programa: RelContratoCapa.php
# Objetivo: Programa que Seleciona a Requisição de Contrato para Emissão de Relatório
...
AddMenuAcesso( '/contratos/RelContratoCapaPdf.php' );
...
//		console.log(registro);
		if(registro != '' && registro!= null && registro !='undefined' ){
			var registro_selecionado = $("#regitrocontrato").val(registro);
			console.log(registro);
			//return false;
			$("#formPesquisa").attr('action','./RelContratoCapaPdf.php');
			$("#formPesquisa").submit();
		}
	}
    ...
    $(document).ready(function() {
		...
		$.post("postDadosPesquisaRelContratoCapa.php",{op:"OrgaoGestor"}, function(data){
	  ...
	  $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosPesquisaRelContratoCapa.php",
					{
						op					:"PesquisaContrato",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosPesquisaRelContratoCapa.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
...
<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
	...
	<input type="hidden" name="idregistro" id="regitrocontrato">
		...
		<table cellpadding="3" border="0" summary="">
			...
			<tr>
				<td width="150"></td>
				<td class="textonormal" width="55%" style=" position:absolute;" >
