...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadApostilamentoIncluirPesquisar.php
...
<script language="javascript" type="">
    ...
    $(document).ready(function() {
		...
		$.post("postDadosPesquisaApostilamentoIncluir.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosPesquisaApostilamentoIncluir.php",
					{
						op					:"Pesquisa",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosPesquisaApostilamentoIncluir.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
...
<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
	...
	<input type="hidden" name="idregistro" id="regitrocontrato">
		...
		<table cellpadding="3" border="0" summary="">
			...
			<tr>
				<td width="150"></td>
				<td class="textonormal" width="850px">
								...
								<table border="0" width="100%" summary="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="textonormal" width="50%">
                                            ...
                                            <div class="textonormal" style = "margin-top: -20px;"  id="mostracnpj" >
                                            ...
                                            <div class="textonormal" style = "margin-top: -20px;" id="mostracpf" >
