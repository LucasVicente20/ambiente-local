...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: CadAditivoPesquisar.php
...
//		console.log(registro);
		if(registro != '' && registro!= null && registro !='undefined' ){
			...
			$("#formPesquisa").attr('action','./CadAditivoIncluir.php');
			$("#formPesquisa").submit();
		}
	}
	<!--
    $(document).ready(function() {
		...
		$.post("postDadosAditivoIncluirPesquisa.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosAditivoIncluirPesquisa.php",
					{
						op					:"PesquisaContrato",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosAditivoIncluirPesquisa.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
								...
								<table border="0" width="100%" summary="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="textonormal" width="50%">
											...
											<br>
                                            <div class="textonormal"  class="inputfornecedor"  id="mostracnpj" >
											    <input type="text" name="cnpj" id="cnpj">
                                                <a href="#" style="margin-left: 40px;" class="btn-pesquisa-fornecedor">
                                                    <img style = "margin-left: -40px; "  src="../midia/lupa.gif" border="0">
                                                </a>
												<br>
										    </div>
