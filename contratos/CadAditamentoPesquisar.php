...
<script language="javascript" type="">
				...
				if(orgao[k].eorglidesc != '' && orgao[k].eorglidesc != 'undefined'){
					...
					for(i in objJson){
						if(orgao[k].eorglidesc == objJson[i].eorglidesc){
							...
							tableHtml     +='<td>'+objJson[i].ectrpcobje+'</td>';
    ...
    $(document).ready(function() {
		...
		$.post("postDadosPesquisaMedicao.php",{op:"OrgaoGestor"}, function(data){
        ...
        $("#btnPesquisar").on('click', function(){
			...
			$.post("postDadosPesquisaMedicao.php",
					{
						op					:"Pesquisa",
						cpf					:$("#cpf").val(),
						cnpj				:$("#cnpj").val(),
        ...
        $(".btn-pesquisa-fornecedor").on('click', function(){
			const documento = $("input[name='cpf-cnpj']:checked").val();
			$.post("postDadosPesquisaMedicao.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
