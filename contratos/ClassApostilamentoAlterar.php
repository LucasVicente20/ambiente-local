...
$codCont = $_SESSION['ssid'];

require_once dirname(__FILE__) . '/../funcoes.php';
# -------------------------------------------------------------------------
#Programa: ClassApostilamentoAlterar.php
...
# -------------------------------------------------------------------------
    ...
    class ApostilamentoAlterar
    {
        ...
        public function alteraDadosApostilamento($dadosSalvar)
        {
            ...
            //var_dump($dadosSalvar['AFORCRSEQU']);die;
            ...
            $sql .= " SET CTPAPOSEQU = ".$dadosSalvar['CTPAPOSEQU'].", AAPOSTNUAP= ". $dadosSalvar['AAPOSTNUAP'].
                        ...
                        "', TAPOSTULAT = now(), VAPOSTRETR = '".$valorRetroativo."', AFORCRSEQU = '".$cod_fornecedor;  
    ...
    // ===========================================================================================================================================================//
        ...
        */
        ...
        public function getFornecedorApostilamento($cdocpcseq2, $num_apostilamento){
            $sqlforn = "SELECT forn.aforcrsequ as seqfornecedor, forn.nforcrrazs as razao, forn.eforcrlogr as rua, 
            forn.aforcrnume as numero, forn.eforcrcomp as complemento, forn.cforcresta as estado,
            forn.eforcrbair as bairro, forn.nforcrcida as cidade, forn.cceppocodi as cep, forn.aforcrccpf as cpf, 
            forn.aforcrccgc as cnpj, aforcrtels as telefone
            FROM SFPC.TBFORNECEDORCREDENCIADO  as forn
            inner join sfpc.tbapostilamento as ap on 
            (forn.aforcrsequ = ap.aforcrsequ)
            where ap.CDOCPCSEQ2 = $cdocpcseq2 and ap.aapostnuap = $num_apostilamento";
