...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: ClassApostilamentoPesquisar.php
    ...
    Class ApostilamentoPesquisar {
        ...
        public function Pesquisar($dados){
         //   var_dump($dados);die;
            ...
            //O inner join a seguir foi incluido para trazer apenas contratos cadastrados, exclusivo para Apostilamento.
            $sql .= "inner join sfpc.tbapostilamento as ap on ( con.cdocpcsequ=ap.cdocpcseq2 )";
            ...
            // $sql .= " INNER JOIN      sfpc.tbusuariocentrocusto AS UsuarioCusto ON (UsuarioCusto.ccenposequ = CC.ccenposequ) ";  CR#238403
