...
# -------------------------------------------------------------------------
# Portal da Compras
# Programa: RelContratoConsolidado.php
...
if(empty($_REQUEST['portalCompras'])){
	...
	unset($_SESSION['resumidoCompleto']);
	...
	<script language="javascript" type="">
		...
		function selecionar(registro, tipo){
			// formPesquisa
			const tipocont = $("input[name='resumido-completo']:checked").val();
			// var tipo_contrato = JSON.stringify(tipocont);

			if(registro != '' && registro!= null && registro !='undefined' ){
				$("#regitrocontrato").val(registro);
				$('#tipocontrato').val(tipocont);
				$("#formPesquisa").attr('action','./RelContratoConsolidadoPdf.php');
				$("#formPesquisa").submit();
			}
		}
		<!--
		$(document).ready(function() {
			...
			$.post("postDadosPesquisaRelContratoConsolidado.php",{op:"OrgaoGestor"}, function(data){
			...
			$("#btnPesquisar").on('click', function(){
				...
				$.post("postDadosPesquisaRelContratoConsolidado.php",
						{
							op					:"PesquisaContrato",
							cpf					:$("#cpf").val(),
							cnpj				:$("#cnpj").val(),
			...
			$(".btn-pesquisa-fornecedor").on('click', function(){
				const documento = $("input[name='cpf-cnpj']:checked").val();
				$.post("postDadosPesquisaRelContratoConsolidado.php",{op:"Fornecerdor",cpf:$("#cpf").val(),cnpj:$("#cnpj").val(),doc:documento}, function(data){
	...
	<body background="../midia/bg.gif" marginwidth="0" marginheight="0">
		...
		<input type="hidden" name="tipo" id="tipocontrato">
			<br><br><br><br><br>
			<table cellpadding="3" border="0" summary="">
				...
				<tr>
					...
					<td align="left" class="textonormal" colspan="2">
						...
						</a> > Contratos  > Relatório Contrato Consolidado
					</td>
				</tr>
				<!-- Fim do Caminho-->
				<!-- Erro -->
				...
				<tr>
					<td width="150"></td>
					<td class="textonormal" style=" position:absolute;  width : 55%; ">
						<table width="850px" border="1" id="tabelaMaster" cellpadding="3" cellspacing="0" bordercolor="#75ADE6" summary="" class="textonormal"  bgcolor="#FFFFFF">
							<tr>
								<td align="center" bgcolor="#75ADE6" valign="middle" class="titulo3" colspan="4">
												RELATÓRIO CONTRATO CONSOLIDADO
								</td>
							</tr>
							<tr>
								<td colspan="8">
									<table border="0" width="100%" summary="">
										...
										<tr>
											...
											<td class="textonormal" width="50%">
												<input type="radio" name="resumido-completo" id="radio-resumido" value="resumido" checked><label for="resumido">Resumido</label>
												<input type="radio" name="resumido-completo" id="radio-completo" value="completo"><label for="completo">Completo</label>
											</td>
