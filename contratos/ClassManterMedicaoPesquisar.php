    ...
    Class ManterMedicaoPesquisar {
        ...
        public function Pesquisar($dados){
         //   var_dump($dados);die;
            ...
            //O inner join a seguir foi incluido para trazer apenas contratos cadastrados, exclusivo para manter medição.
            $sql .= "inner join sfpc.tbmedicaocontrato as med on ( con.cdocpcsequ=med.cdocpcsequ )";
