                                        ...
                                        <td align="center" bgcolor="#75ADE6" valign="middle" class="titulo3">
                                            ...
                                            <?php
                                                if($_SESSION['CodLoteSelecionado'] <> null) {
                                                    ...
                                                    if( db::isError($resultFornecedores) ){
                                                    ...
                                                    if($QuantidadeFornecedores > 0 and $_SESSION['CodLoteSelecionado'] > 0) {
                                                        ...
                                                        if( db::isError($resultUltimaRodadaLances) ){
                                                        ...
                                                        if($UltimaRodadaLances == '' or $UltimaRodadaLances == null) {
                                                            ...
                                                            if( db::isError($resultValUltimaRodadaLances) ){
                                                    ...
                                                    if($_SESSION['CodSituacaoLoteSelecionado'] == 5) {
                                                        ...
                                                        if (db::isError($ResMotivoFracasso)) {
                                    ...
                                    <tr>
                                        <td class="textonormal" >
                                            <table border="0" width="100%" summary="">
                                                <tr>
                                                    <td width="20%" align="left" bgcolor="#DCEDF7" class="textonormal" colspan="1" style="font-weight: bold;">Comissão eliakim:</td>
